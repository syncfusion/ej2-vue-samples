...
<div class="control-section">
    <div class="content-wrapper">
        <ejs-pivotview id="pivotview" :dataSource="dataSource" :gridSettings="gridSettings" :width="width" :height="height" :enableValueSorting="enableValueSorting" :showFieldList="showFieldList">        
        </ejs-pivotview>
    </div>
</div>
