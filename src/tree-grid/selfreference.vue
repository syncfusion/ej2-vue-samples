...
<div class="col-lg-12 control-section">
    ...
    <p>This sample demonstrates the way of binding self-referential flat data to Tree Grid component.
    </p>
</div>
<div id="description">
    <p>Tree Grid can be bound either to local or remote data services. 
        The <code>dataSource</code> property can be assigned either with the array of JavaScript objects or instance of <code>DataManager</code>.</p>
            <p>In this demo, the array of self-referential flat data with parent ID is assigned as the data source to the Tree Grid.</p>
        <p>
            More information on the self-referential data binding can be found in this
            <a target="_blank" 
                href="https://ej2.syncfusion.com/vue/documentation/treegrid/data-binding/local-data/#self-referential-data-binding-flat-data">
