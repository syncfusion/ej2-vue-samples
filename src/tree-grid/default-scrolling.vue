...
<div id="description">
    ...
    <p>The <code><a target="_blank" class="code"
        href="https://ej2.syncfusion.com/vue/documentation/api/treegrid/#height">height</a></code> and <code><a target="_blank" class="code"
        href="https://ej2.syncfusion.com/vue/documentation/api/treegrid/#width">width</a></code> property 
        is used to set the Tree Grid height and width respectively. 
    ...
    <p>
        ...
        href="https://ej2.syncfusion.com/vue/documentation/api/treegrid/#height">height</a></code> and <code><a target="_blank" class="code"
        href="https://ej2.syncfusion.com/vue/documentation/api/treegrid/#width">width</a></code> property of the Tree Grid 
        is set to <strong><em>400</em></strong> and <strong><em>auto</em></strong>
