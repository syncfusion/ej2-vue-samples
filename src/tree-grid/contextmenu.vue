...
<div class="col-lg-12 control-section">
    <div>
        <ejs-treegrid :dataSource='data' :allowResizing="true" childMapping='subtasks' :height='350' :treeColumnIndex='1' :allowPaging='true' :pageSettings='pageSettings' :allowExcelExport='true' :allowPdfExport='true' :allowSorting='true'
        :contextMenuItems="contextMenuItems" :editSettings='editing'>
            <e-columns>
               ...
               <e-column field='duration' headerText='Duration' width='110' minWidth="100" textAlign='Right' :edit='editparams' editType='numericedit' :validationRules='durationrules'></e-column>
               <e-column field='progress' headerText='Progress' width='110' minWidth="100" textAlign='Right' :edit='editparams'  editType= 'numericedit' :validationRules='progressrules'></e-column>
            </e-columns>
        </ejs-treegrid>
    </div>
...
<script lang="ts">
import { TreeGridComponent, ColumnDirective, ColumnsDirective, ContextMenu, Sort, Edit, ExcelExport, PdfExport, Page, Resize, RowDD } from "@syncfusion/ej2-vue-treegrid";
