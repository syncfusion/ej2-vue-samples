...
<div class="control-section">
    ...
    <br/>
    <p>
        More information on the filter configuration can be found in this <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/treegrid/filtering/filtering">documentation section</a>.
    </p>
</div> 
</div>
</template>
