<template>
    <div>
        ...
        <div id="action-description">
            <p>This sample demonstrates the creation of all the types of annotations in the PDF Viewer such as Text Markup,
                Shapes, Measurements, Free text, Stamps, Handwritten signature, ink, and sticky notes. Also, we can
                customize the added annotation or we can include new annotations through user interaction from the PDF
                Viewer.</p>
        </div>
