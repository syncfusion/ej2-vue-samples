    ...
    <div>
        ...
        <ejs-toolbar id="customToolbar" ref="toolbar">
            <e-items>
                ...
                <e-item prefixIcon='e-pv-next-page-navigation-icon' id="nextPage" tooltipText='Next Page' align='Center'
                ...
                <e-item prefixIcon='e-pv-print-document-icon' tooltipText='Print' align='Right'
                    :click="printClicked"></e-item>
                <e-item prefixIcon='e-pv-download-document-icon' tooltipText='Download' align='Right'
                    :click="downloadClicked"></e-item>
            </e-items>
        </ejs-toolbar>
        <ejs-toolbar id="magnificationToolbar">
            <e-items>
                ...
                <e-item prefixIcon='e-pv-zoom-out-icon' id="zoomOut" tooltipText='Zoom out'
...
<script>
import { PdfViewerComponent, Toolbar, Magnification, Navigation, LinkAnnotation, BookmarkView, ThumbnailView, Print, TextSelection, TextSearch } from "@syncfusion/ej2-vue-pdfviewer";
