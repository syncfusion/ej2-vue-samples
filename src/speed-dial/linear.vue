<template>
    <div class="control-section">
        <div id="speed-dial-wrapper">
            <div id="target" class="speeddial-linear-target custom-index">
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' cssClass="e-success" :items="items" target='#target'
                    position='TopLeft' title='Top Left'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' :items="items" target='#target'  cssClass="e-warning"
                    position='TopCenter' title='Top Center'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' cssClass="e-success" :items="items" target='#target'
                    position='TopRight' title='Top Right'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' :items="items" target='#target'  cssClass="e-warning"
                    position='MiddleLeft' title='Middle Left' direction="Right"></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' :items="items" target='#target'
                    position='MiddleCenter' title='Middle Center'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' :items="items" target='#target'  cssClass="e-warning"
                    position='MiddleRight' title='Middle Right' direction="Left"></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' cssClass="e-success" :items="items" target='#target'
                    position='BottomLeft' title='Bottom Left'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' :items="items" target='#target' cssClass="e-warning"
                    position='BottomCenter' title='Bottom Center'></ejs-speeddial>
                <ejs-speeddial openIconCss='speeddial-icons speeddial-icon-upload' cssClass="e-success" :items="items" target='#target'
                    position='BottomRight' title='Bottom Right'></ejs-speeddial>
            </div>
        </div>
