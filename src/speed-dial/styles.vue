        ...
        <div id="speed-dial-wrapper">
            <ejs-tooltip id="details" target=".tooltip-speeddial .e-speeddial-li" position="LeftCenter">
                <div id="target"  class="speeddial-appearence-target custom-index">
                    <ejs-speeddial id="speeddial1" content="Edit" target="#target" position="BottomCenter" openIconCss="speeddial-icons speeddial-icon-edit" iconPosition="Left" :items="items"></ejs-speeddial>
                    <ejs-speeddial id="speeddial2" content="Edit" target="#target" position="BottomLeft" :items="itemLabel"></ejs-speeddial>
                    <ejs-speeddial id="speeddial3" title="Edit" target="#target" position="BottomRight" cssClass="tooltip-speeddial" openIconCss="speeddial-icons speeddial-icon-edit" :items="tooltItem"></ejs-speeddial>
                </div>
            </ejs-tooltip>
        </div>
