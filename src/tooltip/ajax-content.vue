<template>
  <div class="control-section tooltip-ajax">
    ...
    <p>The AJAX request should be made within the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/tooltip/#beforerender">beforeRender</a> event of the tooltip, and on every success, the corresponding
        retrieved data will be set to the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/tooltip/#content">content</a> property of the tooltip.</p>
    <p>More information on loading dynamic tooltip content can be found in the
        <a href="https://ej2.syncfusion.com/vue/documentation/tooltip/content/#dynamic-content-via-ajax" target="_blank"> documentation section</a>.
    </p>
            </div>
    </div>
