...
<div>
  <div class="control-section tooltip-smart">
    ...
    <div id="description">
        ...
        <p>In this sample, the tooltip is opened manually by using its <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/tooltip/#open">open</a> method on drag start of the target image.
        On further dragging, the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/tooltip/#refresh">refresh</a> method of the tooltip needs to be called to reposition it
        continuously and on drag stop, the tooltip will be hidden by using it’s <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/tooltip/#close">close</a> method.</p>
