<template>
  <div class="col-lg-12 control-section slider-bar">
    ...
    <div id="description">
      <p>In this demo, customization of track using <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/slider#cssclass">CSS</a> is demonstrated.</p>
      <ul>
        <li>
