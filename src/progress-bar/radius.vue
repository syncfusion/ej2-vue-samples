<template>
 <div class="control-section progress-bar-parent">
   ...
   <div class="row">
    ...
    <div id="description">
      <p> This demo for Essential JS2 Progress Bar control shows the customizing options for radius, inner-radius, pie progress, track and progress thickness.</p>
    </div>
 </div>
 </template>
<style>
...
export default Vue.extend({
  ...
  loaded: function(args) {
    ...
    {
      let element = document.getElementById('circular-container_Circulartrack');
