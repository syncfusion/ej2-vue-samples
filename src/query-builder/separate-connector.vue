<template>
    <div class="control-section">
        <div class="col-lg-12 querybuilder-control">
            <ejs-querybuilder id="querybuilder" :dataSource="dataSource" ref="querybuilder" :rule="importRules" width="100%" :ruleChange="updateContentTemplate" :created="onQrybldrCreated" :enableSeparateConnector= "enableSeparateConnector">
                <e-columns>
    ...
    <div id="description">
        <p>
            In this demo, the Query Builder includes a separate connector feature that displays a combinator between each neighboring pair of rules or groups within a group's rules. You can enable or disable this feature using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/query-builder/#enableSeparateConnector">enableSeparateConnector</a> property. 
        </p>
        <p>
