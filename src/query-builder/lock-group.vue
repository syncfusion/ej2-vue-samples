<template>
    <div class="control-section">
        <div class="col-lg-12 querybuilder-control">
            <ejs-querybuilder id="querybuilder" :dataSource="dataSource" ref="querybuilder" :rule="importRules" width="100%" :created="onQrybldrCreated" :showButtons="{ lockGroup: true, lockRule: true }">
                <e-columns>
