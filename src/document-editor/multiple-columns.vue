...
<div id="description">
    ...
    <p style="display: block">More information about the document editor features can be found in this <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/section-format/">documentation section.</a>
    </p>
</div>
  </div>
</template>
...
import { multipleColumn } from "./data";
...
export default {
    ...
    mounted() {
        this.$nextTick(function () {
          var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
          obj.open(JSON.stringify(multipleColumn));
          obj.documentName='Multiple Columns';
