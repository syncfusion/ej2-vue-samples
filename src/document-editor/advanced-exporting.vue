    ...
    <div class="control-section">
        <div class="sample-container">
            <div class="default-section">
                ...
                <ejs-documenteditorcontainer ref="doceditcontainer" :serviceUrl="hostUrl" :toolbarItems="toolbarItems"
...
export default {
        ...
        let listviewInstance = new ListView({
            dataSource: [
                ...
                },
                {
                    ...
                    text: 'PDF (*.pdf)',
                    id: 'pdf',
                    category: 'Server side exporting',
                },
                {
                    class: 'data',
        ...
        return {
            ...
            toolbarItems: [
                ...
                'Open',
                {
                    tooltipText: 'Export',
                    template:
                        '<button title="Export" class="e-tbar-btn e-tbtn-txt e-control e-btn e-lib e-dropdown-btn e-caret-hide" type="button" id="dropdownbtn"><span class="e-btn-icon e-icons e-export e-icon-left"></span><span class="e-tbar-btn-text">' +
                        'Export' +
                        '</span><span class="e-btn-icon e-icons e-icon-right e-caret"></span></button><div id="listview"></div>',
                    id: 'dropdownbtn',
                    text: 'Export',
                },
                'Separator',
    ...
    methods: {
        ...
        export: function (type) {
            createSpinner({
                target: document.getElementById('doceditcontainer')
            });
            showSpinner(document.getElementById('doceditcontainer'));
            let format = type;
            let documentName = this.$refs.doceditcontainer.ej2Instances.documentEditor.documentName;
            let url = this.$refs.doceditcontainer.ej2Instances.documentEditor.serviceUrl + 'Export';
            ...
            http.onload = function () {
                if (http.status === 200) {
                    ...
                    downloadLink.download = documentName + '.' + (format).toLowerCase();
                    document.body.appendChild(downloadLink);
                    hideSpinner(document.getElementById('doceditcontainer'));
                    downloadLink.click();
    ...
    mounted() {
        this.$nextTick(function () {
            ...
            this.drpDownBtn.appendTo('#dropdownbtn');
        });
    },
};
</script>
