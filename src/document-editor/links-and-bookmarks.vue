...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
    ...
    <p>This sample demonstrates hyperlinks and bookmarks support in document editor. A file, mail, webpage, or bookmark can be added as a link to the text. </p>
</div>
<div id="description">
    ...
    <p style="display: block">You can also add your own screen tip text for a hyperlink. More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/bookmark/">documentation section.</a>
    </p>
</div>
  </div>
</template>
...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Hyperlinks and Bookmarks',
