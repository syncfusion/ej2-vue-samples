...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
    ...
    <p>This sample demonstrates paragraph formatting options in document editor such as indentation, spacing, and text alignment.</p>
</div>
<div id="description">
    <p style="display: block">In this example, paragraph formatting features in the document editor can be found.</p>
    <ul>
    ...
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/paragraph-format/">documentation section.</a>
    </p>
</div>
    </div>
</template>
...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Paragraph Formatting',
