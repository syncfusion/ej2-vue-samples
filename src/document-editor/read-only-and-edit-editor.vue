      ...
      <div class="default-section">
        <div ref="de_titlebar" id="documenteditor_titlebar" class="e-de-ctn-title">
          <div v-on:keydown="titleBarKeydownEvent" v-on:click="titleBarClickEvent" class="single-line"
           ...
           <ejs-button id="de-close" :style="iconStyle" iconCss='e-icons e-close' v-on:click="closeBtnClick"
            title="Close this document"></ejs-button>
          ...
          <ejs-dropdownbutton id="de-export" ref="de-export" :style="iconStyle" :items="exportItems" :iconCss="exportIconCss"
