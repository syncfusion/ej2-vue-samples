<template>
  <div class="control-section">
    ...
    <p>This sample demonstrates bullets and numbering support in document editor. Both single list and multi-level lists are supported. </p>
    </div>
    <div id="description">
      ...
      newTabClick: function () {
        document
          ...
          .setAttribute(
            ...
            "samples/document-editor/bullets-and-numbering/index.html#fabric"
          );
      }
    }
  });
