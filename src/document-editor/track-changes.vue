...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' :enableTrackChanges='true' height='600px' currentUser = 'Nancy Davolio' userColor='#b70f34'></ejs-documenteditorcontainer>            
        </div>
    </div>
...
<div id="description">
    ...
    <p style="display: block">Features of Trackchanges:</p>
    <ul>
