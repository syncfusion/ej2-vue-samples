...
<ejs-documenteditorcontainer ref="doceditcontainer" :serviceUrl="hostUrl" :enableToolbar='true' :layoutType='layoutType' :toolbarMode="'Ribbon'" height='600px'></ejs-documenteditorcontainer>            
        </div>
    </div>
...
<div id="description">
    <p>In this example, you can view the documents in single page using the Continuous layout type.
    </p>
    <p style="display: block">Supported layout types:</p>
    <ul>
        <li>Pages</li>
        <li>Continuous</li>
    </ul>
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/how-to/change-document-view/">documentation section.</a>
    </p>
</div>
</div>
</template>
...
export default {
    ...
    mounted() {
        this.$nextTick(function () {
          var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
          obj.open(JSON.stringify(weblayout));
          obj.documentName='Web Layout';
