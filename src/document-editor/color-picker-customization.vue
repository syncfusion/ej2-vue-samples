<template>
    ...
    <div id="action-description">
      <p>
        This example explains how to customize the color picker used for font,
        border color in Document.
      </p>
    </div>
    <div id="description">
      <p>
        Color picker's can be customized for the default apperance as Picker or
        Palette mode for font, border color.
      </p>
      <p style="display: block">
        More information about the document editor features can be found in this
        <a
          target="_blank"
          href="https://ej2.syncfusion.com/vue/documentation/document-editor/getting-started/"
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        settings: {showRuler: true, colorPickerSettings : {mode: 'Palette' , modeSwitcher: true , showButtons: true }},
        documentName: 'Color Picker Customization',
    ...
    methods: {
      ...
      initializePicker: function (args) {
        var isPicker = this.$refs.pickerRadio.ej2Instances.checked;
        if (isPicker) {
          this.$refs.doceditcontainer.ej2Instances.documentEditorSettings.colorPickerSettings = {mode: 'Picker'};
        }
      },
      initializePalette: function (args) {
        var isPalette = this.$refs.paletteRadio.ej2Instances.checked;
        if (isPalette) {
          this.$refs.doceditcontainer.ej2Instances.documentEditorSettings.colorPickerSettings = {mode:'Palette'};
        }
      },
      showButtons: function (args) {
        this.$refs.doceditcontainer.ej2Instances.documentEditorSettings.colorPickerSettings = {showButtons : args.checked};
      },
      modeSwitch: function (args) {
        this.$refs.doceditcontainer.ej2Instances.documentEditorSettings.colorPickerSettings = {modeSwitcher : args.checked};
      },
    },
    mounted() {
