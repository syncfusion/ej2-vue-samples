...
<div class="flex-container">
  ...
  <div class="sample-container">
    ...
    <ejs-button id="de-print" ref="de-print" :style="iconStyle" :iconCss="printIconCss" v-on:click="printBtnClick" title="Print this document (Ctrl+P).">Print</ejs-button>	
...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
    ...
    <p>This sample demonstrates the character formatting options in DocumentEditor such as bold, italic, underline, strikethrough, subscript, superscript, font, font size, font color, and highlight color.
    </p>
</div>
<div id="description">
    <p>In this example, you can find character formatting features in the document editor.
    </p>    
    <ul>
    ...
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/text-format/">documentation section.</a>
    </p>
</div>
  </div>
</template>
...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Character Formatting',
    ...
    mounted() {
        this.$nextTick(function () {
          var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
          obj.open(JSON.stringify(characterFormat));
