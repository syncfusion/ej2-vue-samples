<template>
  <div class="control-section">
    ...
    <p>This sample demonstrates table formatting options in document editor such as cell margins, cell spacing, horizontal merge, vertical merge, border styles, background color, and more. </p>
</div>
<div id="description">
      ...
      newTabClick: function () {
        document
          ...
          .setAttribute(
            ...
            "samples/document-editor/table-formatting/index.html#fabric"
          );
      }
    }
  });
