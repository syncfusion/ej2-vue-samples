<template>
    <div>
        ...
        <table style="margin-top: 20px; margin-bottom: 30px;">
            <tr>
                <td style="width: 100%;">                
                    <ejs-checkbox label='Show ruler' :checked="true" :change="onChange"></ejs-checkbox>
                </td>
            </tr>
        </table>
        </div>
        <div id="action-description">
            <p>This example demonstrates how to enabled the ruler in Document Editor.</p>
        </div>
        <div id="description">
            <p>In this example, you can set tab stops, margins, indents and move table borders.</p>    
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/javascript/documentation/document-editor/getting-started/">documentation section.</a>
        </p>
        </div>
    </div>
    </template>
    ...
    provide:{
      ...
      methods: {
        ...
        onChange: function(args) {
            this.$refs.doceditcontainer.ej2Instances.documentEditorSettings.showRuler = args.checked;
        },
