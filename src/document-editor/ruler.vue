...
<ejs-documenteditorcontainer ref="doceditcontainer" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
    ...
    <p>This example demonstrates how to enable the ruler in Document Editor.</p>
</div>
<div id="description">
    <p>In this example, you can set tab stops, margins, indents and move table borders.
    </p>
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/overview">documentation section.</a>
    </p>
</div>
</div>
</template>
