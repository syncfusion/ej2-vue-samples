...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
    ...
    <p>This sample demonstrates header and footer support in document editor. Different headers and footers can be added to the first page, odd pages, and even pages. </p>
</div>
<div id="description">
    <p style="display: block"> Header and footer features in document editor.</p>
    <ul>
    ...
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/header-footer/">documentation section.</a>
    </p>
</div>
  </div>
</template>
...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Headers and Footers',
