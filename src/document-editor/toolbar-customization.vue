...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Toolbar Customization',
          ...
          iconStyle: 'float:right;background: transparent;box-shadow:none;border-color: transparent;border-radius: 2px;color:inherit;font-size:12px;text-transform:capitalize;margin-top:4px;height:28px;font-weight:400;font-family:inherit;',
            ...
            waterMark: 'Select Toolbar Items',
            popHeight: '350px',
            multiMode: 'CheckBox',
            filterPlaceholder: 'Search toolbar items',
            showSelectAll: true,
    ...
    provide:{
      ...
      methods: {
        ...
        updateToolbarItems: function () {
          var items = this.$refs.multiSelect.ej2Instances.value;
