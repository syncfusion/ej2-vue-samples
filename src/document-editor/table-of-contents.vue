...
<ejs-documenteditorcontainer ref="doceditcontainer" :toolbarMode="'Ribbon'" :serviceUrl="hostUrl" :enableToolbar='true' height='600px'></ejs-documenteditorcontainer>            
   ...
   <div id="action-description">
    <p>This sample demonstrates table of contents support in document editor. Many options are available for including table of contents such as hyperlink, page number, right-aligned tabs, and styles. </p>
</div>
<div id="description">
    ...
    <p style="display: block"> More information about the document editor features can be found in this
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/document-editor/table-of-contents/">documentation section.</a>
    </p>
</div>
  </div>
</template>
...
export default {
    ...
    data: function() {
        return {
          ...
          documentName : 'Table of Contents',
    ...
    mounted() {
        this.$nextTick(function () {
          var obj = this.$refs.doceditcontainer.ej2Instances.documentEditor;
          obj.open(JSON.stringify(toc));
          obj.documentName='Table of Contents';
