...
import { RichTextEditorPlugin,  Toolbar, Link, Image, ToolbarType, HtmlEditor, QuickToolbar } from "@syncfusion/ej2-vue-richtexteditor";
    ...
    methods: {
        ...
        actionCompleteHandler: function(e) {
           if (e.targetItem && (e.targetItem === 'SourceCode' || e.targetItem === 'Preview')) {
                this.$refs.rteInstance.ej2Instances.sourceCodeModule.getPanel().style.display = 'none';
                this.mirrorConversion(e);
            }
            else {
                var proxy = this;
                setTimeout(function () { proxy.$refs.rteInstance.ej2Instances.toolbarModule.refreshToolbarOverflow(); }, 400);
            }
        }
    },
    provide:{
