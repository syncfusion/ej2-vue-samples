<template>
  <div class="col-lg-12 control-section default-ribbon-section">
    <div class="simplified-ribbon-container">
      <div id="ribbonContainer">
        <div id="ribbon">
          <ejs-ribbon id="simplified" ref="simplifiedRibbon" :fileMenu="fileSettings" :launcherIconClick="launcherIconClicked" activeLayout="Simplified">
            <e-ribbon-tabs>
                ...
                <e-ribbon-groups>
                  <e-ribbon-group header="Clipboard" id="clipboard" groupIconCss="e-icons e-paste" :showLauncherIcon="true" >
                    <e-ribbon-collections>
                      <e-ribbon-collection>
                        <e-ribbon-items>
                          <e-ribbon-item type="SplitButton" :disabled="true" id="simplified-pastebtn" :allowedSizes="largeSize" :splitButtonSettings="pasteSettigs" >
                          </e-ribbon-item>
                        </e-ribbon-items>
                      </e-ribbon-collection>
                      <e-ribbon-collection>
        ...
        <div id="ribbonPlaceHolder-simplified">
...
export default {
  ...
  methods: {
    enablePaste: function() {
        ...
        this.$refs.simplifiedRibbon.enableItem('simplified-pastebtn')
        pasteDisabled = false;
    },
    ...
    updateContent: function (args) {
        ToastUtility.show({
        target: "#ribbonPlaceHolder-simplified",
...
<style>
  ...
  #ribbonPlaceHolder-simplified .e-toast-close-icon {
      position: absolute;
      top: 50%;
      right: 2px;
  ...
  #ribbonPlaceHolder-simplified .content1 {
      background-color: #3a9ae5;
      width: 150px;
      height: 60%;
  }

  #ribbonPlaceHolder-simplified .content2 {
      background-color: #9d9c9a;
      width: calc(100% - 160px);
      height: 60%;
  }

  #ribbonPlaceHolder-simplified .content3 {
      background-color: #7f7e7d;
      width: 150px;
      height: calc(40% - 10px);
  }

  #ribbonPlaceHolder-simplified .content4 {
      background-color: #c8c6c4;
      width: calc(100% - 160px);
      height: calc(40% - 10px);
  }

  #ribbonPlaceHolder-simplified .e-toast-content {
      padding-right: 25px;
  }
  ...
  #simplified #header_footer .e-ribbon-group-overflow-ddb {
      min-width: 10ch;
  }
  ...
  .simplified-ribbon-container [class^="sf-icon-"], .simplified-ribbon-container [class*=" sf-icon-"] {
  ...
  .simplified-ribbon-container .sf-icon-3d-model:before {
      content: "\e700";
  }

  .simplified-ribbon-container .sf-icon-shapes:before {
      content: "\e701";
  }

  .simplified-ribbon-container .sf-icon-dictate:before {
      content: "\e702";
  }

  .simplified-ribbon-container .sf-icon-chart:before {
      content: "\e703";
  }

  .simplified-ribbon-container .sf-icon-screenshot:before {
      content: "\e704";
  }

  .simplified-ribbon-container .sf-icon-smart-art:before {
      content: "\e706";
  }

  .simplified-ribbon-container .sf-icon-share:before {
      content: "\e707";
  }

  .simplified-ribbon-container .sf-icon-read:before {
      content: "\e708";
  }

  .simplified-ribbon-container .sf-icon-web-layout:before {
      content: "\e709";
  }

  .simplified-ribbon-container .sf-icon-mode:before {
      content: "\e70b";
  }

  .simplified-ribbon-container .sf-icon-draft:before {
      content: "\e70c";
  }

  .simplified-ribbon-container .sf-icon-reuse:before {
      content: "\e70f";
  }

  .simplified-ribbon-container .sf-icon-editor:before {
      content: "\e70a";
  }

  .simplified-ribbon-container .sf-icon-word:before {
      content: "\e70d";
  }
</style>
