<template>
  <div class="col-lg-12 control-section ribbon-keyTip-section">
    <div class="ribbon-keyTip-container">
    <div id="ribbonContainer">
      <div id="ribbon">
        <ejs-ribbon id="keytip-ribbon" ref="ribbonKeyTip" :enableKeyTips="true" layoutSwitcherKeyTip="ZR" :backStageMenu="backstageSettings"
          :launcherIconClick="launcherIconClicked" :created="ribbonCreated">
          <e-ribbon-tabs>
              ...
              <e-ribbon-groups>
                <e-ribbon-group header="Clipboard" id="clipboard" groupIconCss="e-icons e-paste">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="SplitButton" keyTip='V' :disabled="true" id="default-pastebtn" :allowedSizes="largeSize"
                    ...
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        ...
                        <e-ribbon-item type="Button" keyTip='FP' :buttonSettings="formatButton">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                </e-ribbon-group>
                <e-ribbon-group header="Font" orientation="Row" overflowHeader="More Font Options" :enableGroupOverflow="true" launcherIconKeyTip="FJ" :showLauncherIcon="true" :isCollapsible="false"
                  groupIconCss="e-icons e-bold" cssClass="font-group">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="ComboBox" keyTip='FF' :comboBoxSettings="styleOptions">
                        </e-ribbon-item>
                        <e-ribbon-item type="ComboBox" keyTip='FS' :comboBoxSettings="sizeOptions">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="ColorPicker" keyTip='CP' :displayOptions="colorPickerDisplayMode" allowedSizes="Small"
                          :colorPickerSettings="colorPicker">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='1' allowedSizes="Small" :buttonSettings="boldButton">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='2' allowedSizes="Small" :buttonSettings="italicButton">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='3' allowedSizes="Small" :buttonSettings="underlineButton">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='4' allowedSizes="Small" :buttonSettings="strikethroughButton">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='5' allowedSizes="Small" :buttonSettings="caseButton">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                </e-ribbon-group>
                <e-ribbon-group header="Paragraph" launcherIconKeyTip="PG" :showLauncherIcon="true" orientation="Row" groupIconCss="e-icons e-align-center" >
                    <e-ribbon-collections>
                      <e-ribbon-collection>
                        <e-ribbon-items>
                          <e-ribbon-item type="Button" keyTip='AO' allowedSizes="Small" :buttonSettings="decreaseIndent">
                          </e-ribbon-item>
                          <e-ribbon-item type="Button" keyTip='AI' allowedSizes="Small" :buttonSettings="increaseIndent">
                          </e-ribbon-item>
                          <e-ribbon-item type="Button" keyTip='FM' allowedSizes="Small" :buttonSettings="paragraphBtn">
                          </e-ribbon-item>
                        </e-ribbon-items>
                      </e-ribbon-collection>
                      <e-ribbon-collection>
                ...
                <e-ribbon-group header="Editing" orientation="Row" groupIconCss="e-icons e-edit">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="SplitButton" keyTip='FD' :splitButtonSettings="searchOptions">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='R' :buttonSettings="replaceButton">
                        </e-ribbon-item>
                        <e-ribbon-item type="SplitButton" keyTip='S' :splitButtonSettings="selectOptions">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Voice" :isCollapsible="false" groupIconCss="sf-icon-dictate">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="SplitButton" keyTip='D' :allowedSizes="largeSize" :splitButtonSettings="dictateOptions">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Editor" :isCollapsible="false" groupIconCss="sf-icon-editor">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='SU' :allowedSizes="largeSize" :buttonSettings="editorButton">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Reuse Files" :isCollapsible="false" groupIconCss="sf-icon-reuse">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='RF' :disabled="true" :allowedSizes="largeSize"
                          :buttonSettings="reuseButton">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
            ...
            <e-ribbon-tab header="Insert" keyTip="N">
              <e-ribbon-groups>
                ...
                <e-ribbon-group header="Illustrations" id="illustration" overflowHeader="Illustrations" orientation="Row"
                  :enableGroupOverflow=true groupIconCss="e-icons e-image">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item id="pictureddl" keyTip='P' type="DropDown" :dropDownSettings="pictureSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="DropDown" keyTip='SA' :dropDownSettings="shapeSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='3D' :buttonSettings="modelSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='M' :buttonSettings="artSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='CC' :buttonSettings="chartSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='SS' :buttonSettings="screenshotSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                </e-ribbon-group>
                <e-ribbon-group header="Header & Footer" id="header_footer" orientation="Column"
                  groupIconCss="e-icons e-table">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="DropDown" keyTip='H' :dropDownSettings="headerSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="DropDown" keyTip='HF' :dropDownSettings="footerSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="DropDown" keyTip='NU' :dropDownSettings="pageSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Comments" :isCollapsible=false>
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='C' :allowedSizes="largeSize" :buttonSettings="commentSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Links" groupIconCss="e-icons e-link" :isCollapsible=false>
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="DropDown" keyTip='L2' :allowedSizes="largeSize" :dropDownSettings="linkSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
            ...
            <e-ribbon-tab header="View" keyTip="W">
              <e-ribbon-groups>
                <e-ribbon-group header="Views" orientation="Row" groupIconCss="e-icons e-print">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='F' :buttonSettings="readSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='LP' :buttonSettings="printSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='W' :buttonSettings="layoutSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Zoom" orientation="Row" groupIconCss="e-icons e-zoom-to-fit">
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='Q' :buttonSettings="zoomInSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="Button" keyTip='J' :buttonSettings="zoomOutSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Show" :isCollapsible=false>
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="CheckBox" keyTip='VR' :checkBoxSettings="rulerSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="CheckBox" keyTip='VG' :checkBoxSettings="gridSettings">
                        </e-ribbon-item>
                        <e-ribbon-item type="CheckBox" keyTip='VN' :checkBoxSettings="navigationSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
                ...
                <e-ribbon-group header="Dark Mode" :isCollapsible=false>
                  <e-ribbon-collections>
                    <e-ribbon-collection>
                      <e-ribbon-items>
                        <e-ribbon-item type="Button" keyTip='D' :allowedSizes="largeSize" :buttonSettings="modeSettings">
                        </e-ribbon-item>
                      </e-ribbon-items>
                    </e-ribbon-collection>
                  </e-ribbon-collections>
      ...
      <div id="ribbonPlaceHolder-default">
      ...
      <div id="pictureList">
        <ejs-listview id="listview" :dataSource="pictureList" :showHeader=true headerTitle="Insert Picture From"
          :select="listItem"></ejs-listview>
      </div>
    </div>
    </div>
  </div>
...
import { RibbonKeyTip, RibbonBackstage, RibbonItemSize } from '@syncfusion/ej2-vue-ribbon';
...
export default {
  ...
  name: "App",
  provide: {
    ribbon: [RibbonKeyTip, RibbonColorPicker, RibbonBackstage]
  },
  data: function () {
    return {
      ...
      backstageSettings: {
        ...
        items: [
          ...
          { id: 'print', text: 'Print', backStageItemClick: this.backstageClickHandler, keyTip: 'P' },
      ...
      cutButton: { iconCss: "e-icons e-cut", content: "Cut", clicked: () => { this.updateContent("Cut"); this.enablePaste(); } },
      copyButton: { iconCss: "e-icons e-copy", content: "Copy", clicked: () => { this.updateContent("Copy"); this.enablePaste(); } },
      formatButton: { iconCss: "e-icons e-format-painter", content: "Format Painter", clicked: () => { this.updateContent("Format Painter") } },
      styleOptions: {
      ...
      underlineButton: { iconCss: "e-icons e-underline", content: "Underline", isToggle: "true", clicked: () => { this.updateContent("Underline") } },
      strikethroughButton: { iconCss: "e-icons e-strikethrough", content: "Strikethrough", isToggle: "true", clicked: () => { this.updateContent("strikethrough") } },
      caseButton: { iconCss: "e-icons e-change-case", content: "Change Case", isToggle: "true", clicked: () => { this.updateContent("Change Case") } },
      colorPicker: { value: "#123456", change: (args) => { this.updateContent(args.currentValue.hex + " color") } },
      searchOptions: {
        ...
        click: () => { this.updateContent("Find") }
      },
      replaceButton: { iconCss: "e-icons e-replace", content: "Replace", clicked: () => { this.updateContent("Replace") } },
      selectOptions: {
        iconCss: "e-icons e-mouse-pointer", content: "Select",
        items: [{ text: "Select All" }, { text: "Select Objects" }],
        select: (args) => { this.updateContent("Select -> " + args.item.text) },
        click: () => { this.updateContent("Select") }
      },
      dictateOptions: {
        iconCss: 'sf-icon-dictate', content: 'Dictate',
        items: [{ text: 'Chinese' }, { text: 'English' }, { text: 'German' }, { text: 'French' }],
        select: (args) => { this.updateContent("Dictate -> " + args.item.text) },
        click: () => { this.updateContent("Dictate") }
      },
      editorButton: { iconCss: "sf-icon-editor", content: "Editor", clicked: () => { this.updateContent("Editor") } },
      reuseButton: { iconCss: "sf-icon-reuse", content: "Reuse Files", clicked: () => { this.updateContent("Reuse Files") } },
      tableSettings: {
        ...
        select: (args) => { this.updateContent("Table -> " + args.item.text) }
      },
      pictureSettings: {
        iconCss: 'e-icons e-image', content: 'Pictures', isDropDownButton: true, target: '#pictureList'
      },
      shapeSettings: {
        iconCss: 'sf-icon-shapes', content: 'Shapes', isDropDownButton: true,
        items: [{ text: 'Lines' }, { text: 'Rectangles' }, { text: 'Basic Arrows' }, { text: 'Basic Shapes' }, { text: 'FlowChart' }],
        select: (args) => { this.updateContent("Shapes -> " + args.item.text) }
      },
      modelSettings: { iconCss: "sf-icon-3d-model", content: "3D Models", clicked: () => { this.updateContent("3D Models") } },
      artSettings: { iconCss: "sf-icon-smart-art", content: "SmartArt", clicked: () => { this.updateContent("SmartArt") } },
      chartSettings: { iconCss: "sf-icon-chart", content: "Chart", clicked: () => { this.updateContent("Chart") } },
      screenshotSettings: { iconCss: "sf-icon-screenshot", content: "Screenshot", clicked: () => { this.updateContent("Screenshot") } },
      headerSettings: {
        iconCss: 'e-icons e-header', content: 'Header',
        items: [{ text: 'Insert Header' }, { text: 'Edit Header' }, { text: 'Remove Header' }],
        select: (args) => { this.updateContent("Header -> " + args.item.text) }
      },
      footerSettings: {
        iconCss: 'e-icons e-footer', content: 'Footer',
        items: [{ text: 'Insert Footer' }, { text: 'Edit Footer' }, { text: 'Remove Footer' }],
        select: (args) => { this.updateContent("Footer -> " + args.item.text) }
      },
      pageSettings: {
        iconCss: 'e-icons e-page-numbering', content: 'Page Number',
        items: [{ text: 'Insert Top of page' }, { text: 'Insert Bottom of page' }, { text: 'Format Page Number' }, { text: 'Remove Page Number' }],
        select: (args) => { this.updateContent("Page Numbering -> " + args.item.text) }
      },
      commentSettings: { iconCss: "e-icons e-comment-add", content: "New Comment", clicked: () => { this.updateContent("New Comment") } },
      linkSettings: {
        iconCss: 'e-icons e-link', content: 'Link',
        items: [
        ...
        select: (args) => { this.updateContent("Link -> " + args.item.text) }
      },
      readSettings: { iconCss: "sf-icon-read", content: "Read Mode", clicked: () => { this.updateContent("Read Mode") } },
      printSettings: { iconCss: "e-print e-icons", content: "Print Layout", clicked: () => { this.updateContent("Print Layout") } },
      layoutSettings: { iconCss: "sf-icon-web-layout", content: "Web Layout", clicked: () => { this.updateContent("Web Layout") } },
      zoomInSettings: { iconCss: "e-icons e-zoom-in", content: "Zoom In", clicked: () => { this.updateContent("Zoom In") } },
      zoomOutSettings: { iconCss: "e-icons e-zoom-out", content: "Zoom Out", clicked: () => { this.updateContent("Zoom Out") } },
      rulerSettings: { label: "Ruler", checked: false, change: () => { this.updateContent("Ruler") } },
      gridSettings: { label: "Gridlines", checked: false, change: () => { this.updateContent("Gridlines") } },
  ...
  methods: {
    enablePaste: function () {
      ...
      this.$refs.ribbonKeyTip.enableItem('default-pastebtn');
      isPasteDisabled = false;
    },
    launcherIconClicked: function (args) {
      if (args.groupId == "clipboard") {
        this.updateContent("Clipboard LauncherIcon");
      }
      else if (args.groupId == "illustration") {
        this.updateContent("Illustration LauncherIcon");
      }
      else if (args.groupId == "header_footer") {
        this.updateContent("Header & Footer LauncherIcon");
      }
    },
    ribbonCreated: function(args) {
      if (!isBackstageOpened) {
        this.$refs.ribbonKeyTip.ej2Instances.element.querySelector('.e-ribbon-backstage').addEventListener('click', this.onBackstageOpen.bind(this));
      }
      this.$refs.ribbonKeyTip.ej2Instances.ribbonKeyTipModule.showKeyTips();
    },
    onBackstageOpen: function() {
      isBackstageOpened = true
      this.$refs.ribbonKeyTip.ej2Instances.element.querySelector('.e-ribbon-backstage-content').addEventListener('click', this.handleClickInsideBackstageContent.bind(this));
    },
    listItem(args) {
    ...
    updateContent: function (args) {
      ToastUtility.show({
        target: "#ribbonPlaceHolder-default",
...
.ribbon-keyTip-container #ribbonContainer {
  padding: 20px;
...
#ribbonPlaceHolder-default .e-toast-close-icon {
  position: absolute;
  top: 50%;
  right: 2px;
...
#ribbonPlaceHolder-default .content1 {
  background-color: #3a9ae5;
  width: 150px;
  height: 60%;
}

#ribbonPlaceHolder-default .content2 {
  background-color: #9d9c9a;
  width: calc(100% - 160px);
  height: 60%;
}

#ribbonPlaceHolder-default .content3 {
  background-color: #7f7e7d;
  width: 150px;
  height: calc(40% - 10px);
}

#ribbonPlaceHolder-default .content4 {
  background-color: #c8c6c4;
  width: calc(100% - 160px);
  height: calc(40% - 10px);
}

#ribbonPlaceHolder-default .e-toast-content {
  padding-right: 25px;
}
