...
.e-addressbar-breadcrumb {
  margin-left: 0 !important;
}

.bootstrap .e-addressbar-breadcrumb ol,
.bootstrap4 .e-addressbar-breadcrumb ol,
.bootstrap-dark .e-addressbar-breadcrumb ol {
  margin-left: -16px;
}
...
.e-bigger.bootstrap5-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon,
.e-bigger.bootstrap5 .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon {
  margin-top: -2px;
  padding-right: 26px !important;
}

.e-bigger.fabric-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon {
  padding-right: 25px !important;
}
.e-bigger.fabric .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon,
...
.material3 .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.material3-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.e-bigger .material3 .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.e-bigger .material3-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.tailwind3 .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.tailwind3-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.e-bigger .tailwind3 .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret,
.e-bigger .tailwind3-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item .e-caret
{
    right: 2px;
}
</style>
<!-- custom code end -->
<style>
    .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon {
  padding-right: 20px !important;
  padding-left: 0px !important;
  overflow: hidden;
}

.tailwind .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon,
.tailwind-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon,
.e-bigger.bootstrap-dark .e-addressbar-breadcrumb .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon {
  padding-right: 25px !important;
}
...
.e-addressbar-breadcrumb .e-breadcrumb-item,
.e-addressbar-breadcrumb .e-breadcrumb-separator {
  padding: 0px !important;
}

.fabric .e-addressbar-breadcrumb .e-menu {
  padding: 0 8px !important;
}

.fabric .e-bigger .e-addressbar-breadcrumb .e-menu {
  padding: 0 12px !important;
}

.fabric .e-addressbar-breadcrumb .e-breadcrumb-item .e-menu,
.highcontrast .e-addressbar-breadcrumb .e-breadcrumb-item .e-menu,
.fabric-dark .e-addressbar-breadcrumb .e-breadcrumb-item .e-menu {
  padding: 0 !important;
}

.e-addressbar-breadcrumb .e-menu-wrapper {
  border: none;
}
