<template>
    <div class="control-pane">
        <div class="control-section">
            <img src="src/ai-document-editor/images/smart-editor.gif" width="100%" height="100%" />
        </div>
        <div id="action-description">
            <p>
                This sample demonstrates the capabilities of the Smart Editor in enhancing document editing within the
                Syncfusion JavaScript Document Editor. Users can refine their content by:
            </p>
            <ul>
        ...
        <div id="description">
            ...
            <p><strong>Translation:</strong> The translation feature allows users to convert the document content into
                multiple
                languages. This is particularly useful for creating multilingual documents or understanding content
                written in
                foreign languages.</p>
        </div>
    </div>
