<template>
    <div class="control-pane">
        <div class="control-section">
            <img src="src/ai-document-editor/images/writing-assist.gif" width="100%" height="100%" />
        </div>
        <div id="action-description">
            <p>
        The Writing Assist feature is designed to generate new content based on user-provided ideas or prompts,
        seamlessly integrating the content into the document editor. This tool, available in the Syncfusion JavaScript
    ...
    <p>To explore this and more Syncfusion JavaScript Smart AI integrations locally, check out our <a target='_blank'
            href= 'https://github.com/syncfusion/smart-ai-samples/tree/master/vue' aria-label="Navigate to explore the syncfusion JavaScript AI Demos repository">GitHub
            repository</a>.</p>
        </div>
        <div id="description">
