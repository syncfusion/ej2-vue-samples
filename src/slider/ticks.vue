  ...
  <div class="col-lg-8 control-section ticks">
    <div class="content-wrapper">
        <div class="sliderwrap">
            ...
            <ejs-slider id='default' :value='value' :min='min' :max='max' :step='step' :ticks="ticks"></ejs-slider>
        </div>
        <div class="sliderwrap ticks">
            <label style="padding-bottom: 50px">Range Slider</label>
            <ejs-slider id='range' :value='rangevalue' :type='rangetype' :min='min' :max='max' :step='step' :ticks='rangeticks'></ejs-slider>
        </div>
    </div>
</div>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 50%;padding-right: 10px;padding-top: 10px">
                        <div>
                            <ejs-dropdownlist id='filter-type' dropdownlist :dataSource='datasource' :fields='fields' index=0 :change='onChange'
                                placeholder='Select a Placement' popupHeight='200px'></ejs-dropdownlist>
                        </div>
                    </td>
                </tr>
                <tr>
...
export default Vue.extend({
  data: function() {
    return {
     ...
     datasource: [{ value: 'Before', text: 'Before' }, { value: 'After', text: 'After' }, { value: 'Both', text: 'Both' },
