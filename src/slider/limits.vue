  ...
  <div class="col-lg-8 limits control-section" >
      <div class="content-wrapper" id="all-option-sample">
           <div class='sliderwrap'>
            ...
            <ejs-slider ref="slider" id="limitslider" :value="value" :min="min" :max="max" :type="type" :tooltip="tooltip" :ticks="ticks" 
     :step="step" :limits="limits" >
        ...
        <div class='sliderwrap limits'>
            ...
            <ejs-slider ref="rangeslider" :value="rangevalue" :min="min" :max="max"  :type="rangetype" :tooltip="rangetooltip" :ticks="rangeticks" 
     :step="step" :limits="rangelimits" >
    ...
    <table id="property" title="Properties">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 50%;padding-right: 10px">
                    <div>
                        <ejs-numerictextbox :min="min" :max="max" :value="minendvalue" :change="minendChange"></ejs-numerictextbox>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 50%;padding-right: 10px">
                    <div>
                        <ejs-numerictextbox :min="min" :max="max" :value="maxstartvalue" :change="maxstartChange"></ejs-numerictextbox>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 50%;padding-right: 10px">
                    <div>
                        <ejs-numerictextbox :min="min" :max="max" :value="maxendvalue"  :change="maxendChange"></ejs-numerictextbox>
                    </div>
                </td>
            </tr>
            <tr>
...
<div id="description">
    ...
    <p>
        <table>
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#minstart">minStart</a>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#minend">minEnd</a>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#maxstart">maxStart</a>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#maxend">maxEnd</a>
                </td>
                <td>
                    - &nbsp;&nbsp;Used to set maximum limit value for first handle.
                </td>
            ...
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#starthandlefixed">startHandleFixed</a>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/api-limitData.html#endhandlefixed">endHandleFixed</a>
                </td>
                <td>
    ...
    <p>For more information, refer to the
        <a target="_blank" href="http://ej2.syncfusion.com/vue/documentation/slider/limits.html">limits</a> section from the documentation.</p>
</div>
    </div>
...
export default Vue.extend({
  ...
  methods: {
    minstartChange: function(args) {
      this.$refs.slider.$el.ej2_instances[0].limits.minStart = args.value;
      this.$refs.rangeslider.$el.ej2_instances[0].limits.minStart = args.value;
    },
    minendChange: function(args) {
      this.$refs.slider.$el.ej2_instances[0].limits.minEnd = args.value;
      this.$refs.rangeslider.$el.ej2_instances[0].limits.minEnd = args.value;
    },
    maxstartChange: function(args) {     
      this.$refs.rangeslider.$el.ej2_instances[0].limits.maxStart = args.value;
    },
    maxendChange: function(args) {
      this.$refs.rangeslider.$el.ej2_instances[0].limits.maxEnd = args.value;
    },
    lockFirstHandle: function(args) {
      this.$refs.slider.$el.ej2_instances[0].limits.startHandleFixed = args.checked;
      this.$refs.rangeslider.$el.ej2_instances[0].limits.startHandleFixed = args.checked;
    },
    lockSecondHandle: function(args) {
      this.$refs.slider.$el.ej2_instances[0].limits.endHandleFixed = args.checked;
      this.$refs.rangeslider.$el.ej2_instances[0].limits.endHandleFixed = args.checked;
    },
     onScroll: function(){
        if(!isNullOrUndefined(document.getElementById('limitslider'))){
        this.$refs.slider.$el.ej2_instances[0].refreshTooltip();
        this.$refs.rangeslider.$el.ej2_instances[0].refreshTooltip();
        }
    }
  },
 mounted: function(){
