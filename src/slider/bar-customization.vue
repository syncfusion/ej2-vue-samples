 ...
 <div class="col-lg-12 control-section">
    <div class="slider-content-wrapper">
        ...
        <div class="slider_container">
            ...
            <ejs-slider id='dynamic_color_slider' :value='dynamic_value' :min='min' :max='max' :type='range' :created='created' :change='change'></ejs-slider>
        </div>
    </div>
...
<script>
import Vue from "vue";
import { SliderPlugin, SliderChangeEventArgs  } from "@syncfusion/ej2-vue-inputs";
