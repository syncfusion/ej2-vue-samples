  ...
  <div class="col-lg-12 control-section tooltipcustomization">
    <div class="content-wrapper">
        <div class="sliderwrap">
            ...
            <ejs-slider id='defaultTooltip' :value='value' :min='min' :max='max' :step='step' :created='onCreated' :tooltipChange='tooltipChangeHandler' :tooltip='tooltip'
                :renderingTicks='renderingTicksHandler' :ticks='ticks' type='Range' >
            </ejs-slider>
        </div>
        <div class="sliderwrap">
            <label class="labeltext userselect">
            ...
            <ejs-slider id='out' :value='slidervalue' :min='min' :max='max' :step='step' :tooltipChange='tooltipChangeHandler' :tooltip='tooltip'
                :renderingTicks='renderingTicksHandler' :ticks='ticks' type='MinRange' >
            </ejs-slider>
        </div>
    </div>
...
export default Vue.extend({
  ...
  methods:{
    ...
    onCreated: function(args) {
        let defaultObj = document.getElementById('defaultTooltip').ej2_instances[0];
        defaultObj.keyUp({ keyCode: 9, target: defaultObj.secondHandle });
        defaultObj.secondHandle.focus();
    },
    onScroll: function() {
        if(!isNullOrUndefined(document.getElementById('defaultTooltip'))){
        let defaultObj = document.getElementById('defaultTooltip').ej2_instances[0];
        let outObj = document.getElementById('out').ej2_instances[0];
