        ...
        <table title="Properties" id="property">
            <tbody>
                <tr>
                    <td>
                        <div>
                            <ejs-checkbox id="check" checked="true" label='Auto Check' ref="checkInstance" :change = "change"></ejs-checkbox>
                        </div>
                    </td>
                </tr>
            </tbody>
...
<div id="description">
    <p>The <code>TreeView</code> component can be rendered with checkbox on the left side of each tree node. This allows the user to check more than one nodes, and this can be enabled by the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/treeview/#showcheckbox">showCheckBox</a> property.</p>
    <p>In this demo, the TreeView is populated with checkbox enabled.</p>
    <p>For more information, you can refer to the <a href="https://ej2.syncfusion.com/vue/documentation/treeview/check-box/" target="_blank">Checkboxes</a> section from the documentation.</p>
</div>
</div>
</template>
/* custom code start */
