...
<div class="control-section" id="sidebar-wrapper">
    ...
    <div class="sidebar-default-wrapper">
        <div>
    ...
    <ejs-sidebar id="defaultSidebar" ref="sidebar" class="default-sidebar" width="260px" target=".maincontent" position="Left">
        <ejs-treeview id="defaultTree" :fields="treeFields" v-on:nodeSelecting="beforeSelect" v-on:nodeSelected="onSelect">
        </ejs-treeview>
    </ejs-sidebar>
    </div>
...
export default Vue.extend({
    data: function() {
        return {
            ...
            listData: dataSource.inboxData,
            fields: { id: "id", text: "text" },
            treeFields: { dataSource: dataSource.treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded" },
        }
    },
    methods: {
        onListSelect :function(args) {
            args.cancel = true;
        },
        ...
        onSelect: function(args) {
            ...
            if (args.nodeData.text == "Inbox") {
                ...
                ListData = dataSource.sentItemData;
            }
            else if (args.nodeData.text == "Drafts") {
                ListData = dataSource.draftsData;
            }
            else if (args.nodeData.text == "Deleted Items") {
                ListData = dataSource.deleteData;
            }
            else if (args.nodeData.text == "Outbox") {
                ListData = dataSource.outBoxData;
            }
...
<style>
    ...
    .e-bigger #sidebar-wrapper .e-content-animation {
        height: 477px;
    }

    /* Specifies the border bottom color for the Listview and toolbar in light theme*/
    .material #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .fabric #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .tailwind #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .highcontrast #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .defaultToolbar.e-toolbar {
        border-bottom: 1px solid #eaeaeae0;
    }

    /* Specifies the border bottom styles for the Listview and toolbar in dark theme*/
    .material-dark #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .material-dark .defaultToolbar.e-toolbar,
    .fabric-dark #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .fabric-dark .defaultToolbar.e-toolbar,
    .tailwind-dark #sidebar-wrapper .e-listview .e-list-item:not(:last-child),
    .tailwind-dark .defaultToolbar.e-toolbar,
    .bootstrap5-dark .defaultToolbar.e-toolbar {
        border-bottom: 1px solid #eaeaea63;
    }

    /* Specifies sample level font icons for toolbar and listview*/
    @font-face {
    ...
    .e-bigger #defaultToolbar .e-tbar-btn .tb-icons {
        font-size: 20px;
    }
    ...
    #defaultToolbar .e-toolbar .e-icons {
        font-size: 20px;
    }
    ...
    /* Specifies sample level styles for toolbar alignment*/

    #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-item:not(.e-separator) {
        padding: 2px;
    }

    .material #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .material-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child {
        margin-left: 21px;
    }

    .e-bigger.material #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .e-bigger.material-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child {
        margin-left: 17px;
    }

    .fabric #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .fabric-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .highcontrast #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .e-bigger.bootstrap #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .e-bigger.bootstrap-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child {
        margin-left: 15px;
    }

    .bootstrap #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .bootstrap-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child {
        margin-left: 18px;
    }

    .e-bigger.fabric #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .e-bigger.fabric-dark #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child,
    .e-bigger.highcontrast #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child
    {
        margin-left: 10px;
        padding: 0px;
    }

    .bootstrap4 #sidebar-wrapper .e-toolbar .e-toolbar-items .e-toolbar-left .e-toolbar-item:first-child {
        margin-left: 6px;
    }
    ...
    .e-bigger .defaultToolbar.e-toolbar .e-folder {
        font-size: 18px;
        margin-left: -4px;
    }

    .e-bigger.bootstrap4 .defaultToolbar.e-toolbar .e-folder {
        margin-left: 0;
    }

    .tailwind .defaultToolbar.e-toolbar .e-folder,
    .tailwind-dark .defaultToolbar.e-toolbar .e-folder,
    .bootstrap4 .defaultToolbar.e-toolbar .e-folder {
        margin-top: 2px;
    }

    .material .defaultToolbar.e-toolbar .e-folder,
    .material-dark .defaultToolbar.e-toolbar .e-folder,
    .bootstrap .defaultToolbar.e-toolbar .e-folder,
    .highcontrast .defaultToolbar.e-toolbar .e-folder,
    .bootstrap-dark .defaultToolbar.e-toolbar .e-folder {
        margin-top: 1px;
    }

    .fabric .defaultToolbar.e-toolbar .e-folder,
    .fabric-dark .defaultToolbar.e-toolbar .e-folder {
        margin-top: 1px;
        margin-left: -3px;
    }

    .defaultToolbar.e-toolbar .e-user-name {
        font-weight: 500;
        font-size: 14px
    }

    /* Specifies sample level styles for ListView*/
    .material-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line .e-list-item-header,
    .material-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line .e-list-content,
    .bootstrap-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line .e-list-content {
        color: #fff;
    }
   ...
   #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar {
    ...
    .tailwind #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .tailwind-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar {
        margin-left: 14px;
    }

    .material #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .material-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar {
        margin: 14px 16px 14px 0;
    }

    .fabric #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .fabric-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .highcontrast #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar {
        margin: 6px 0 0 -5px;
    }

    .bootstrap4 #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .bootstrap #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar,
    .bootstrap-dark #sidebar-wrapper .e-listview.e-list-template .e-list-wrapper.e-list-multi-line.e-list-avatar .e-avatar {
        margin: 12px 0 0 -4px;
    }

    .material .sidebar-default-wrapper,
    .fabric .sidebar-default-wrapper,
    .tailwind .sidebar-default-wrapper,
    .fluent .sidebar-default-wrapper,
    .bootstrap5 .sidebar-default-wrapper {
        border: 1px solid #d7d7d7;
    }

    .material-dark .sidebar-default-wrapper,
    .fabric-dark .sidebar-default-wrapper,
    .tailwind-dark .sidebar-default-wrapper,
    .highcontrast .sidebar-default-wrapper,
    .fluent-dark .sidebar-default-wrapper,
    .bootstrap5-dark .sidebar-default-wrapper {
