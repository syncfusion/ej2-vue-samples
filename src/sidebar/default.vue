...
<div class="control-section sidebar-default">
    ...
    <div id="wrapper">
        <div class="col-lg-12 col-sm-12 col-md-12">
         <span id="hamburger" class="sidebar-icons menu default" v-on:click="openClick()"></span>
            <!-- Sidebar element declaration -->
            <ejs-sidebar id="default-sidebar" ref="sidebar" :position="position">
                <div class="title-header">
                    <div style="display:inline-block"> Sidebar</div>
                    <span id="close" class="sidebar-icons" v-on:click="closeClick"></span></div>
                <div class="sub-title">
    ...
    <div id="description">
        ...
        <p>
              This sample demonstrates the basic <code>Sidebar</code> component. Click the toggle button to expand or collapse the sidebar.
        </p>
   </div>
</div>
</template>
