...
Vue.use(SidebarPlugin, TreeViewPlugin);
...
<template>
<div class='control-section sidebar-tree'>
...
<style>
   /* header-section styles */
    .sidebar-tree #header-section.main-header {
    ...
    .sidebar-tree #header-section .header-style {
        line-height: 40px;
        height: 40px;
        padding: 8px;
        list-style: none;
    ...
    .sidebar-tree #header-section .border-left {
        border-left: 1px solid #d2d6de;
        width: 10em;
    }

    .sidebar-tree #header-section .float-left {
        float: left;
    }

    .sidebar-tree #header-section .icon-menu {
        width: 40px;
    }
    /* custom code start */
    .sb-content-tab .sidebar-tree #wrapper {
        display: none;
    }
    ...
    .sb-content-tab .sidebar-tree .center {
        display: block;
    }
    /* custom code end */
    .sidebar-tree #header-section .float-right,
    .sidebar-tree #sidebar-treeview .e-treeview .e-icon-collapsible,
    .sidebar-tree #sidebar-treeview .e-treeview .e-icon-expandable {
        float: right;
    }

    .sidebar-tree #header-section .header-list,
    .sidebar-tree #sidebar-treeview .e-treeview,
    .sidebar-tree #sidebar-treeview .e-treeview .e-ul {
        padding: 0px;
        margin: 0px;
    }
    /* custom code start */
    @media(max-width:800px) {
        ...
        .sidebar-tree #header-section .support {
            display: none;
        }

        .sidebar-tree #header-section .nav-pane {
            width: 75%;
        }
    }
    /* custom code end */
    ...
    .sidebar-tree #sidebar-treeview .main-menu .main-menu-header {
        color: #656a70;
    padding: 15px;
    font-size: 14px;
    width: 13em;
    ...
    /*text input styles */
    .sidebar-tree #sidebar-treeview .main-menu .search-icon {
        text-indent: 10px;
        height: 30px;
        width: 18em;
    }
    ...
    .sidebar-tree #sidebar-treeview .table-content {
        padding: 20px;
    height: 5em;
    }
    ...
    /* content area styles */
    .sidebar-tree #main-text.main-content {
        overflow: hidden;
    }

    .sidebar-tree #main-text .sidebar-content .line {
        width: 100%;
        height: 1px;
    ...
    .sidebar-tree #main-text .sidebar-content {
        padding: 15px;
    }

    .sidebar-tree #main-text .sidebar-heading {
        color: #1c86c8;
        margin: 40px 0;
        padding: 2px;
    }

    .sidebar-tree #main-text .paragraph-content {
    ...
    .sidebar-tree #sidebar-treeview #main-treeview .icon {
        font-family: 'fontello';
        font-size: 16px;
    }

    .sidebar-tree #header-section.main-header .icon-menu::before {
        content: '\e801';
        font-family: 'fontello';
        font-size: 27px;
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-microchip::before {
        content: '\e806';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-thumbs-up-alt::before {
        content: '\e805';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-docs::before {
        content: '\e802';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-th::before {
        content: '\e803';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-code::before {
        content: '\e804';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-chrome::before {
        content: '\e807';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-up-hand::before {
        content: '\e810';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-bookmark-empty::before {
        content: '\e811';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-help-circled::before {
        content: '\e813';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-doc-text::before {
        content: '\e812';
    }

    .sidebar-tree #sidebar-treeview #main-treeview .icon-circle-thin::before {
        content: '\e808';
    }
