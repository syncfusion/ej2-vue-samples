...
<template>
<div class='control-section sidebar-res'>
...
<style>
   /* header-section styles */
    .sidebar-res #header-section.main-header {
    ...
    .sidebar-res #header-section .header-style {
        line-height: 40px;
        height: 40px;
        padding: 8px;
        list-style: none;
    ...
    .sidebar-res #header-section .border-left {
        border-left: 1px solid #d2d6de;
        width: 10em;
    }

    .sidebar-res #header-section .float-left {
        float: left;
		padding-right: 0px;
    }

    .sidebar-res #header-section .icon-menu {
        width: 40px;
    }
    /* custom code start */
    .sb-content-tab .sidebar-res #wrapper {
        display: none;
    }
    ...
    .sb-content-tab .sidebar-res .center {
        display: block;
    }
    /* custom code end */
    .sidebar-res #header-section .float-right,
    .sidebar-res #sidebar-treeview .e-treeview .e-icon-collapsible,
    .sidebar-res #sidebar-treeview .e-treeview .e-icon-expandable {
        float: right;
    }

    .sidebar-res #header-section .header-list,
    .sidebar-res #sidebar-treeview .e-treeview,
    .sidebar-res #sidebar-treeview .e-treeview .e-ul {
        padding: 0px;
        margin: 0px;
    }
    /* custom code start */
    @media(max-width:800px) {
        ...
        .sidebar-res #header-section .support {
            display: none;
        }

        .sidebar-res #header-section .nav-pane {
            width: 75%;
        }
    }
    /* custom code end */
    ...
    .sidebar-res #sidebar-treeview .main-menu .main-menu-header {
        color: #656a70;
    padding: 15px;
    font-size: 14px;
    width: 13em;
    ...
    /*text input styles */
    .sidebar-res #sidebar-treeview .main-menu .search-icon {
        text-indent: 10px;
        height: 30px;
        width: 18em;
    }
    ...
    .sidebar-res #sidebar-treeview .table-content {
        padding: 20px;
    height: 5em;
    }
    ...
    /* content area styles */
    .sidebar-res #main-text.main-content {
        overflow: hidden;
    }

    .sidebar-res #main-text .sidebar-content .line {
        width: 100%;
        height: 1px;
    ...
    .sidebar-res #main-text .sidebar-content {
        padding: 15px;
    }

    .sidebar-res #main-text .sidebar-heading {
        color: #1c86c8;
        margin: 40px 0;
        padding: 2px;
    }

    .sidebar-res #main-text .paragraph-content {
    ...
    .sidebar-res #sidebar-treeview #main-treeview .icon {
        font-family: 'fontello';
        font-size: 16px;
    }

    .sidebar-res #header-section.main-header .icon-menu::before {
        content: '\e801';
        font-family: 'fontello';
        font-size: 27px;
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-microchip::before {
        content: '\e806';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-thumbs-up-alt::before {
        content: '\e805';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-docs::before {
        content: '\e802';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-th::before {
        content: '\e803';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-code::before {
        content: '\e804';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-chrome::before {
        content: '\e807';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-up-hand::before {
        content: '\e810';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-bookmark-empty::before {
        content: '\e811';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-help-circled::before {
        content: '\e813';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-doc-text::before {
        content: '\e812';
    }

    .sidebar-res #sidebar-treeview #main-treeview .icon-circle-thin::before {
        content: '\e808';
    }
