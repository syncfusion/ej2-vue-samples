...
export default {
    ...
    data () {
     ...
     methods: {
       toolbarCliked: function() {
           this.$refs.sidebarTreeviewInstance.toggle();
        }
    }
}
</script>
<style>
    ...
    /* Specifies sample level icons styles */
    @font-face {
    ...
    .tailwind #reswrapper,
    .fluent #reswrapper,
    .bootstrap5 #reswrapper {
        border: 1px solid #d7d7d7;
    }

    .material-dark #reswrapper,
    .fabric-dark #reswrapper,
    .tailwind-dark #reswrapper,
    .highcontrast #reswrapper,
    .fluent-dark #reswrapper,
    .bootstrap5-dark #reswrapper {
