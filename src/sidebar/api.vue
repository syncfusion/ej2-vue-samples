        ...
        <div>
            <div class="list-group">
                <div class="list-group-item">
                    <span id="hamburger" class="e-icons menu" v-on:click='toggleSidebar'></span>
                    ...
                    <div class="inline-element responsive">
                        ...
                        <ejs-button id="apitogglesidebar" cssClass="e-primary inline-element right" :isToggle='true' v-on:click.native="toggleSidebar" content="Toggle"></ejs-button>
                        <br />
                        <br />
                         <!-- Sidebar position -->
                        <p class=" inline-element" style="width:70%">
                        ...
                        <ejs-button ref="sidebarTypesBtn" id="positionBtn" cssClass="e-primary inline-element right" :isToggle='true' content="Left" v-on:click.native="onTypeChange"></ejs-button>
                        <br />
                        <br />
                        <!-- Sidebar types -->
                        ...
                        <ejs-button ref="documentClickBtn" id="documentElement" cssClass="e-primary inline-element right" content="False" :isToggle='true' v-on:click.native="documentClick"></ejs-button>
                        <br />
                        <br />
                         <!-- showbackdrop option -->
                        <p class=" inline-element" style="width:70%"><b>Backdrop</b> - Sets the backdrop over the main content area on open / expanded state. </p>
                        <ejs-button ref="backdropBtn" id="backDropElement" cssClass="e-primary inline-element right" :isToggle='true' content="False" v-on:click.native="backdrop"></ejs-button>
                        <br />
                        <br />
                    </div>
                </div>
...
Vue.use(SidebarPlugin, DropDownListPlugin, ToolbarPlugin);
    ...
    methods: {
        ...
        toggleSidebar: function(){
          ...
          if(this.$refs.backdropBtn.$el.textContent = 'True') {
            this.$refs.sidebarInstance.showBackdrop = true;
          }
        },
        sidebarClose : function() {
          this.$refs.sidebarInstance.hide();
          if (this.$refs.sidebarInstance.showBackdrop == true){
            this.$refs.sidebarInstance.showBackdrop = false;
        }          
        },
