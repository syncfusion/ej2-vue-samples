...
<div>
<ejs-maps id='container' :load='load' :titleSettings='titleSettings' :zoomSettings='zoomSettings' useGroupingSeparator='true'
            format='n'>
    <e-layers>
        <e-layer :urlTemplate= 'urlTemplate'>
            <e-markerSettings>
                <e-markerSetting visible='true' shape='Circle' height='15' width='15' fill='#b38600' :border='markerBorder' :dataSource='markerDataSourceFrance' :clusterSettings='markerClusterSettingsFrance' :tooltipSettings='markerTooltipSettings' ></e-markerSetting>
                <e-markerSetting visible='true' shape='Circle' height='15' width='15' fill='#bf4040' :border='markerBorder' :dataSource='markerDataSourceUSA' :clusterSettings='markerClusterSettingsUSA' :tooltipSettings='markerTooltipSettings' ></e-markerSetting>
                <e-markerSetting visible='true' shape='Circle' height='15' width='15' fill='#00b3b3' :border='markerBorder' :dataSource='markerDataSourceIndia' :clusterSettings='markerClusterSettingsIndia' :tooltipSettings='markerTooltipSettings' ></e-markerSetting>
                <e-markerSetting visible='true' shape='Circle' height='15' width='15' fill='#b366ff' :border='markerBorder' :dataSource='markerDataSourceChina' :clusterSettings='markerClusterSettingsChina' :tooltipSettings='markerTooltipSettings' ></e-markerSetting>
            </e-markerSettings> 
        </e-layer>
    </e-layers>
</ejs-maps>
