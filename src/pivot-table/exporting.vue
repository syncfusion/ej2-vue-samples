    ...
    <div id="description">
        ...
        <p>
            More information on the exporting can be found in these <a target="_blank"
                href="https://ej2.syncfusion.com/vue/documentation/pivotview/excel-export">Excel Export</a> , <a target="_blank"
                href="https://ej2.syncfusion.com/vue/documentation/pivotview/excel-export#csv-export">CSV Export</a> & <a target="_blank"
                href="https://ej2.syncfusion.com/vue/documentation/pivotview/pdf-export">PDF Export</a> documentation section.
        </p>
    </div>
