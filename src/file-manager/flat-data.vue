...
<div>
    <div class="control-section">
         <div class="sample-container">
            <ejs-filemanager id="flat_data" :toolbarSettings='toolbarSettings' :contextMenuSettings="contextMenuSettings" :fileSystemData="fileSystemData">
            </ejs-filemanager>
        </div>
    </div>
    <div id="action-description">
        <p>This sample demonstrates flat data rendering of the File Manager component. The File Manager uses a flat data object as an array of JSON objects for rendering, eliminating the need to define the <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#ajaxSettings" target="_blank">ajaxSettings</a> url.</p>
    </div>
    <div id="description">
...
<script>
import { FileManagerComponent, NavigationPane, Toolbar, DetailsView, Permission, FileData } from "@syncfusion/ej2-vue-filemanager";
