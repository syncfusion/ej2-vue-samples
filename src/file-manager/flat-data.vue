...
<div>
    ...
    <div id="action-description">
        <p>This sample demonstrates the flat data rendering of the File Manager component. The File Manager uses a flat data object as an array of JSON objects for rendering, eliminating the need to define <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#ajaxSettings" target="_blank">ajaxSettings</a> url.</p>
    </div>
    <div id="description">
