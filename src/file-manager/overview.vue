...
<div>
    ...
    <div id="action-description">
        <p>
            The File Manager component is an efficient tool for managing files and folders, providing a comprehensive set of features such as a <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#toolbarsettings" target="_blank"> toolbar</a>, <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#navigationpanesettings" target="_blank"> navigation pane</a> and <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#detailsviewsettings" target="_blank"> details view</a>, which make it easy to create, rename, delete, cut, copy, paste, upload, download, and more. With its user-friendly interface, users can easily navigate through folders and effortlessly select their desired files or folders.
        </p>
    </div>
    <div id="description">
        ...
        <p>The <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#ajaxsettings" target="_blank"> ajaxSettings </a> must be defined when initializing the File Manager, as it uses the URLs specified in <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#ajaxsettings" target="_blank"> ajaxSettings </a> to send file operation requests to the server.</p>
        <p>The context menu can be customized using the <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#contextmenusettings" target="_blank"> contextMenuSettings </a> API, which is used to add new menu items.</p>
        <p>The custom toolbar items can be added and customized using the <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#toolbarsettings" target="_blank"> toolbarSettings </a> API. If a new toolbar is needed, it can be added using the <a href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/#toolbarsettings" target="_blank"> toolbarSettings </a>.</p>
         <p>
