...
<div>
    ...
    <div id="description">
        ...
        <p>To efficiently upload large files and folders to the server in manageable chunks, use the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/file-manager/uploadsettingsmodel/#chunksize">chunkSize</a> property to specify the desired chunk size.</p>
         <p>
