...
<div id="description">
    <p>
        Drawing huge amounts of nodes and connectors on initial loading slows the rendering process down. <a href="https://www.syncfusion.com/vue-components/vue-diagram" target="_blank">Vue Diagram</a> virtualization support helps improve the performance on initial rendering. Virtualization can be enabled by adding the <code>Virtualization</code> flag to the <code>constraints</code> property of the diagram.
    </p>
    <br>
</div>
</div>
