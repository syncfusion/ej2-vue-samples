  ...
  <div id="timeline-container">
    ...
    <div class="control-section timeline-section">
      ...
      <ejs-dialog ref="dialogObject" :visible="false" width="300px" :isModal="true" :target="dialogTarget"
        :animationSettings="dialogAnimation" :buttons="dialogButtons" :header="dialogHeader"
...
.timeline-section [class^="sf-icon-"],
.timeline-section [class*=" sf-icon-"] {
...
<script>
import {
  DiagramComponent, Diagram, SnapConstraints, NodeConstraints, ConnectorConstraints, DiagramTools, DiagramConstraints, randomId,
  SelectorConstraints
...
export default {
  ...
  data: function () {
    ...
    return {
      ...
      constraints: DiagramConstraints.Default & ~DiagramConstraints.PanY & ~DiagramConstraints.UndoRedo,
      commandManager: {
        commands: [
          {
            name: 'copy',
      ...
      dialogTarget: '#timeline-container',
      dialogHeader: 'New Event',
      dialogAnimation: { effect: 'Zoom' },
      dialogButtons: [
        {
