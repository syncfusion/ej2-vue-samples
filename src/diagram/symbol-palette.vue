    ...
    <div class="diagram-palette">
        <div class="control-section">
            <div style="width: 100%;" class="diagram-symbolpalette">
                ...
                <div class="sb-mobile-diagram diagram-column" style="width:59%;float:left">
                    <ejs-diagram style="display: block" id="diagram" ref="diagramObject" :width="diagramwidth"
                        :getNodeDefaults="getNodeDefaults" :height="diagramheight" :rulerSettings="rulerSettings"
                        :scrollSettings='scrollSettings'></ejs-diagram>
                </div>
                <div class="palette-property-panel-section">
                    <div class="property-header"
                        style="font-weight: 500;font-size: 15px;padding-bottom:20px;padding-left: 12px;">Properties
                    </div>
                    <div class="palette-property-panel-content" style="padding-left: 12px;">
                        <table id="properties" title="Properties" style="width: 100%;height:100%;">
                                ...
                                <td>
                                    ...
                                    <div style="padding-left: 20px;">
                                        <ejs-dropdownlist ref="expandObj" id="expand" :index='expandIndex'
                                            :dataSource='expandDataSource' :change='expandChange'
                                            :width='expandWidth' />
                                    </div>
                                </td>
                            </tr>
                            <tr style="height: 50px">
                                ...
                                <td>
                                    ...
                                    <div style="padding-left: 20px;">
                                        <ejs-numerictextbox ref='sizeObj' id='size' :value='sizeValue'
                                            :min='sizeMinimum' :max='sizeMaximum' :width='sizeWidth' :step='sizeStep'
                                            :format='sizeFormat' :change='sizeChange'></ejs-numerictextbox>
                                    </div>
                                </td>
                            </tr>
                            <tr style="height: 50px">
                                <td>
                                    <div style="padding-top: 14px;">Animation </div>
                                </td>
                                <td>
                                    <!-- enable or disable the animation of the symbol palette. -->
                                    <div style="padding-top: 9px;padding-left: 20px;">
                                        <ejs-checkbox id="animation" :checked='animationChecked'
                            ...
                            <tr style="height: 50px">
                                <td>
                                    <div style="padding-top: 14px;">Item Text </div>
                                </td>
                                <td>
                                    <div style="padding-top: 9px;padding-left: 20px;">
                            ...
                            <tr style="height: 50px">
                                <td>
                                    <div style="padding-top: 14px;">Header icon </div>
                                </td>
                                <td>
                                    <div style="padding-top: 9px;padding-left: 20px;">
                                        <ejs-checkbox id="header" :change='headerIconchange'
                                            :checked='headerChecked'></ejs-checkbox>
                                    </div>
                                </td>
                            </tr>
                            <tr style="height: 50px">
                                <td>
                                    <div style="padding-top: 14px;">Show Search TextBox</div>
                                </td>
                                <td>
                                    <div style="padding-top: 9px;padding-left: 20px;">

                                        <ejs-checkbox id="search" :change="enableSearchChange"
                                            :checked="enableSearchChecked"></ejs-checkbox>
        ...
        <div id="action-description">
            <p>
                ...
                drawing
                area. Customizable options of the symbol palette are also illustrated in this example.
            </p>
        </div>
        <div id="description">
            <p>
            ...
            <ul>
                ...
                <li>Activating search functionality with the <code>enableSearch</code> property, allowing users to find
                    symbols
                    by ID or search tags</li>
            </ul>
            <p>Note: The size of <b>"HTML Shapes"</b> in the symbol palette is restricted at runtime when modifying
                symbol size
                property, to maintain a consistent layout and visual appearance.</p>
            <br />
        </div>
    </div>
</template>
<style>
  ...
  .palette-property-panel-content table tr td:first-child {
    width: 50%;
  }

  .palette-property-panel-content {
    overflow: auto;
    min-width: 22%
  }
  ...
  .palette-property-panel-section {
    flex: 1 1 200px;
    min-width: 180px;
  }
...
<script>
      ...
      getHTMLShapes() {
        return [
          ...
          },
          {
            ...
            shape: {
              type: "HTML",
              content: template("BugFix")
            },
             width: 70, height: 55,
             tooltip: { content: 'Bug Fix' }, constraints: NodeConstraints.Tooltip
          },
        ];
      },
    },
  ...
  //Enable or disable the search option for symbol palette
  function onEnableSearchChange(args) {
    if (args.checked) {
  ...
  function updateGetSymbolInfo() {
    ...
    palette.getSymbolInfo = (symbol) => {
      return {
        width:
          symbol.shape.type === 'HTML'  ? htmlSymbolWidth  : symbolSize,
        height:
          symbol.shape.type === 'HTML'  ? isItemText  ? htmlSymbolHeight + 20 : htmlSymbolHeight : symbolSize,
        fit: true,
        description: {
