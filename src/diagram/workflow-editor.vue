                    ...
                    if (completedCount === connectorCollection.length) {
                                ...
                                for (let k = 0; k < connectorCollection.length; k++) {
                                    ...
                                    if ((targetNode.shape).shape !== 'Gateway' && (((targetNode).id !== 'setStatusAsRejected' || (targetNode).id !== 'setStatusAsAccepted' || (targetNode).id !== 'setNextApprovalStatusAsRejected'))) {
                                        let newNode = {
                                            ...
                                            {
                                                type: 'HTML',
                                                content: '<div style="display: flex; flex-direction: column; align-items: center;"><div id="loadingIndicator" class="loading-indicator"></div><div class="nodetick">✓</div></div>'
                                            }
                                        };
                        ...
                        timeOut2 =
                            setTimeout(function () {
                                ...
                                let loadingIndicator2 = document.getElementsByClassName('loading-indicator');
                                ...
                                // To add tick mark.
                                let tick = document.getElementsByClassName('nodetick');
