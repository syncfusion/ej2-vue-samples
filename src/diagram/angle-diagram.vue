<template>
  ...
  <div id="action-description">
    <p>
      This sample demonstrates an interactive solar panel tilt system built with the Syncfusion® EJ2 Vue Diagram component. Adjust the panel angle to see real-time changes in system efficiency based on the sun's position and location.
    </p>
  </div>
  <div id="description">
    <p>
      This interactive diagram visualizes a solar panel system. The sun's path is represented by a curved connector, and users can adjust the panel's tilt angle either by direct rotation or using the numeric input. The system provides immediate feedback through a dynamic efficiency gauge and performance messages. Users can also select different locations to observe how regional variations impact overall solar efficiency.
    </p>
  </div>
</template>
  ...
  data: function () {
    ...
    const nodes = [
      ...
      // Support structure
      {
        ...
        shape: {
          type: 'Image',
          source: './src/diagram/Images/angle/panelSupport.png'
        },
      ...
      // Solar panel (interactive)
      {
        ...
        shape: {
          type: 'Image',
          source: './src/diagram/Images/angle/solarPanel.png'
        },
        style: { fill: 'transparent', strokeColor: 'transparent' }
      },
      // Pivot point
