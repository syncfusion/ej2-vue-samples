...
<div class="col-lg-12 control-section" style="padding-top: 0px;">
 ...
 <div class="content-wrapper" style="width: 100%">
      ...
      <ejs-diagram style='display:block' ref="diagramObj" id="diagram" :width='width' :height='height' :snapSettings='snapSettings' :tool='tool' :layout='layout' :getNodeDefaults='getNodeDefaults' :getConnectorDefaults='getConnectorDefaults' :dataSourceSettings='dataSourceSettings'>
      </ejs-diagram>
  </div>
