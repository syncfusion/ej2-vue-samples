<template>
    ...
    <p>To explore this and more Syncfusion Vue Smart AI integrations locally, check out our <a target='_blank'
        ...
        <div id="description">
            <p>
        This showcase highlights the advanced capabilities of the Syncfusion Vue Pivot Table integrated with AI,
    ...
    <p>
        Users can interact with the EJ2 Pivot Table in real-time to experience the power of AI-assisted data analysis.
