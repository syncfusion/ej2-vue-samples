<template>
    <div class="control-section">
        <div class="orientation-stepper-section">
            <div id="orientation-options">
                <div class="orientation-header-wrapper">
                    <p> Orientation </p>
                    <div class="e-btn-group">
                        <input type="radio" id="horizontal" name="orientation" value="horizontal" v-on:click="updateOrientation" checked/>
                        <label class="e-btn" for="horizontal">Horizontal</label>
                        <input type="radio" id="vertical" name="orientation" value="vertical" v-on:click="updateOrientation" />
                        <label class="e-btn" for="vertical">Vertical</label>
                    </div>
                </div>
                <div class="orientation-header-wrapper">
                    <p> Label Position </p>
            ...
            <div class="orientation-stepper-control">
                <ejs-stepper orientation="horizontal" labelPosition="end" activeStep="1" :steps="orientationSteps" ref="stepper"></ejs-stepper>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        updateOrientation: function (args) {
            this.$refs.stepper.ej2Instances.orientation = args.currentTarget.value;
        },
...
<style>
    ...
    .orientation-stepper-control .sf-icon-ordered:before { content: "\e704"; }
    .orientation-stepper-control .sf-icon-delivery:before { content: "\e705"; }
    .orientation-stepper-control .sf-icon-review:before { content: "\e708"; }
    .orientation-stepper-control .sf-icon-package:before { content: "\e709"; }
