<template>
   <div class="control-section">
    ...
    <div id='container1' class="col-xs-5 col-sm-5 col-lg-4 col-md-4"
        style="display: flex;justify-content: center; align-items: center;">
        <ejs-lineargauge ref="lineargauge1" :background='background' :minimum=0 :maximum=100 :load='load' :width='widthData' :annotations='annotations1'  :title='title1' :titleStyle='titleStyle' :height='heightData' style='display:block' align='center' id='defaultContainer1' :orientation='orientation'>
            <e-axes>
    ...
    <div id='container3' class="col-xs-5 col-sm-5 col-lg-4 col-md-4"
        style="display: flex;justify-content: center; align-items: center;">
        <ejs-lineargauge ref="lineargauge3" :background='background' :minimum=0 :maximum=100 :load='load' :width='widthData3' :annotations='annotations2'  :title='title3' :titleStyle='titleStyle' :height='heightData' style='display:block' align='center' id='defaultContainer3' :orientation='orientation' >
            <e-axes>
