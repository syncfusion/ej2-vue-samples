        ...
        <div class="col-lg-12 control-section">
            <div class="sample_container badge-notification">
                <div class="layout">
                    <div class="margin">
                        <!-- Notification Badge -->
                        <div class="margin fontSize">Notification</div>
                        <div class="badge-block">
                            <div class="whatsapp svg_icons"></div>
                            <!-- Warning Colored Notification Badge -->
                            <span class="e-badge e-badge-warning e-badge-notification e-badge-overlap">99+</span>
                        </div>

                        <div class="badge-block">
                            <div class="twitter svg_icons"></div>
                            <!-- Primary Colored Notification Badge -->
                            <span class="e-badge e-badge-primary e-badge-notification e-badge-overlap">7</span>
                        </div>

                        <div class="badge-block">
                            <div class="facebook svg_icons"></div>
                            <!-- Danger Colored Notification Badge -->
                            <span class="e-badge e-badge-danger e-badge-notification e-badge-overlap">99+</span>
                        </div>
                        <div class="badge-block">
                            <div class="skype svg_icons"></div>
                            <!-- Secondary Colored Notification Badge -->
                            <span class="e-badge e-badge-secondary e-badge-notification e-badge-overlap">18</span>
                        </div>

                        <!-- Circle Badge -->
                        <div class="margin fontSize">Circle</div>
                        <div class="badge-block">
                            <div class="whatsapp svg_icons"></div>
                            <!-- Warning Colored Notification Badge -->
                            <span class="e-badge e-badge-warning e-badge-notification e-badge-overlap e-badge-circle">19</span>
                        </div>

                        <div class="badge-block">
                            <div class="twitter svg_icons"></div>
                            <!-- Primary Colored Notification Badge -->
                            <span class="e-badge e-badge-primary e-badge-notification e-badge-overlap e-badge-circle">27</span>
                        </div>

                        <div class="badge-block">
                            <div class="facebook svg_icons"></div>
                            <!-- Danger Colored Notification Badge -->
                            <span class="e-badge e-badge-danger e-badge-notification e-badge-overlap e-badge-circle">3</span>
                        </div>

                        <div class="badge-block">
                            <div class="skype svg_icons"></div>
                            <!-- Secondary Colored Notification Badge -->
                            <span class="e-badge e-badge-secondary e-badge-notification e-badge-overlap e-badge-circle">85</span>
                        </div>

                        <!-- Dot Badge -->
                        <div class="margin fontSize">Dot</div>
                        <div class="badge-block">
