       ...
       <div class="col-lg-3 property-section property-customization">
        ...
        <div class="property-panel-content">
          <form id="addForm">
                <table>
                    <tr>
                        <td><ejs-textbox ref="header" id="text" class="e-input" type="text" placeholder="Text Field"></ejs-textbox></td>
                    </tr>
                    <tr>
                        <td><ejs-dropdownlist id='key' formControlName="key" ref="Dropdown" :dataSource='statusData' placeholder= 'Key Field'>
                        </ejs-dropdownlist></td>
                    </tr>
                    <tr>
                        <td><ejs-numerictextbox ref='colIndex' id="index" formControlName="index" format='###.##' :min='defaultValue' :value='defaultValue' placeholder="Index">
            ...
            <form id="deleteForm">
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <ejs-numerictextbox ref='columnIndex' id="deteteIndex" formControlName="deteteIndex" format='###.##' :min='defaultValue' :value='defaultValue' placeholder="Index">
                                </ejs-numerictextbox>
                            </td>
                        </tr>
                        <tr>
...
export default {
  ...
  data: function() {
    ...
    statusData: [{ text: 'Testing' }, {  text:'Review' }, {  text:'Validate' }],
