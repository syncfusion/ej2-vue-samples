<template>
  <div class="col-lg-12 control-section msg-variant-section">
    <div class="col-lg-4 col-md-6 content-section">
      <h4>Filled</h4>
      <ejs-message id="col-lg-4 col-md-6 msg_default_filled" variant="Filled">Editing is restricted</ejs-message>
      ...
      <ejs-message id="msg_error_filled" severity="Error" variant="Filled">A problem has been occurred while submitting your data</ejs-message>
    </div>
    <div class="col-lg-4 col-md-6 content-section">
      <h4>Outlined</h4>
      <ejs-message id="col-lg-4 col-md-6 msg_default_outlined" variant="Outlined">Editing is restricted</ejs-message>
      ...
      <ejs-message id="msg_error_outlined" severity="Error" variant="Outlined">A problem has been occurred while submitting your data</ejs-message>
    </div>
    <div class="col-lg-4 content-section">
      ...
      <ejs-message id="msg_error" severity="Error">A problem has been occurred while submitting your data</ejs-message>
    </div>
    <div id="action-description">
      <p>This sample demonstrates the predefined appearance variants for the Vue Message component.</p>
    </div>
    <div id="description">
