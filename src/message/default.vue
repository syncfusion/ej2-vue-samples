<template>
  <div class="col-lg-12 control-section msg-default-section">
    ...
    <div id="description">
      ...
      <p>More information about Message can be found in this <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/message/vue-3-getting-started">documentation</a> section.</p>
    </div>
  </div>
</template>
