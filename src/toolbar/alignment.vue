<template>
    <div class="control-section e-tbar-section-alignment">
...
<style>
    ...
    @font-face {
        font-family: 'Material_toolbar_alignment';
    ...
    .e-bigger .e-tbar-section-alignment .e-tbar-btn .tb-icons {
        font-size: 20px;
    }

    .e-tbar-section-alignment .e-tbar-btn .tb-icons {
        font-family: 'Material_toolbar_alignment';
        speak: none;
        font-size: 16px;
        font-style: normal;
    ...
    .e-tbar-section-alignment .e-toolbar .e-icons {
        font-size: 20px;
    }

    .e-tbar-section-alignment .e-tbar-menu-icon:before {
        content: "\e718";
    }

    .e-tbar-section-alignment .e-tbar-search-icon:before {
        content: "\e71d";
    }

    .e-tbar-section-alignment .e-tbar-settings-icon:before {
        content: "\e702";
    }
    ...
    .e-tbar-section-alignment .e-def-avator span {
        text-align: center;
        line-height: 40px;
        display: block;
    }

    .e-tbar-section-alignment .e-mail-header,
    .e-tbar-section-alignment .e-mail-subject,
    .e-tbar-section-alignment .e-mail-description,
    .e-tbar-section-alignment .e-mail-id {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
    }

    .e-tbar-section-alignment .e-folder {
        text-align: center;
    }
    ...
    .e-tbar-section-alignment .e-mail-item {
        margin-top: 8px;
    ...
    .e-tbar-section-alignment .e-mail-image {
        margin-right: 10px;
        float: left;
        height: 60px;
    }

    .material .e-bigger .e-tbar-section-alignment .e-toolbar .e-tbar-btn .e-icons {
        font-size: 18px;
    }

    .material .e-tbar-section-alignment .e-toolbar .e-tbar-btn .e-icons {
        font-size: 16px;
    }
