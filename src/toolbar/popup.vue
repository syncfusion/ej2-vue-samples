    ...
    <div class="e-sample-resize-container">
        <ejs-toolbar overflowMode='Popup'>
            <e-items>
                ...
                <e-item type='Separator'></e-item>
                <e-item prefixIcon='e-tbar-undo-icon tb-icons' tooltipText='Undo' text='Undo'></e-item>
                <e-item prefixIcon='e-tbar-redo-icon tb-icons' tooltipText='Redo' text='Redo'></e-item>
                <e-item type='Separator'></e-item>
...
<style>
@font-face {
    font-family: 'Material_toolbar_popup';
...
@font-face {
        font-family: 'Material_toolbar2_popup';
...
#toolbar_Popalways .e-tbar-btn .e-icons {
    font-family: 'Material_toolbar2_popup', 'e-icons';
}
...
.e-tbar-section-popup .e-toolbar .e-toolbar-item.e-template {
    cursor: default;
}
