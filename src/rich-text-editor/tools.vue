<template>
    <div>
        ...
        <div id="description">
            ...
            Video, Audio, FormatPainter, PasteCleanup, SlashMenu, ImportExport</code> into the <code>provide</code> section.</p>
        </div>
    </div>
</template>
<style>
...
import { RichTextEditorComponent, Toolbar, Link, Image, Count, HtmlEditor, QuickToolbar, Table, FileManager, EmojiPicker, Video, Audio, FormatPainter, PasteCleanup, SlashMenu, ImportExport } from "@syncfusion/ej2-vue-richtexteditor";
...
export default {
    ...
    provide: {
        richtexteditor: [Toolbar, Link, Image, Count, HtmlEditor, QuickToolbar, Table, FileManager, EmojiPicker, Video, Audio, FormatPainter, PasteCleanup, SlashMenu, ImportExport]
    }
}
</script>