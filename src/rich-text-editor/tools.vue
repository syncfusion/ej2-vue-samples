...
<script>
import { Browser, addClass, removeClass, createElement, getComponent } from "@syncfusion/ej2-base";
import { RichTextEditorComponent, Toolbar, Link, Image, Count, HtmlEditor, QuickToolbar, Table, FileManager, EmojiPicker, Video, Audio, FormatPainter, PasteCleanup, SlashMenu, ImportExport, CodeBlock, ClipBoardCleanup, AutoFormat } from "@syncfusion/ej2-vue-richtexteditor";
...
export default {
    ...
    methods: {
        ...
        handleFullScreen: function (e) {
            ...
            var sideBar = getComponent(sideBarElem, 'sidebar');
            var leftBar;
    ...
    provide: {
        richtexteditor: [Toolbar, Link, Image, Count, HtmlEditor, QuickToolbar, Table, FileManager, EmojiPicker, Video, Audio, FormatPainter, PasteCleanup, SlashMenu, ImportExport, CodeBlock, ClipBoardCleanup, AutoFormat]
    }
}
</script>