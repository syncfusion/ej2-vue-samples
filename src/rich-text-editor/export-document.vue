    ...
    <div class="control-section">
      <div class="sample-container">
        <div class="default-section">
          <ejs-richtexteditor :value="value" :enableXhtml="enableXhtml" :exportWord="exportWord" :exportPdf="exportPdf" :insertImageSettings="insertImageSettings" :toolbarSettings="toolbarSettings">
          </ejs-richtexteditor>
        </div>
      </div>
    </div>
    <div id="action-description">
      <p>This example illustrates how to use the import/export feature of the Rich Text Editor to export the editor content into a PDF or Word document.</p>
    </div>
    <div id="description">
        <p>This example illustrates how to use the import/export feature of the Rich Text Editor to export the editor
          content
          into a PDF or Word document.</p>
      <ol>
