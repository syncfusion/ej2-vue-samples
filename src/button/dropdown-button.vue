...
<div id="description">
    ...
    <p>
        ...
        <code>
            <a target="_blank" class="code" href="http://ej2.syncfusion.com/angular/documentation/drop-down-button/api-dropDownButton.html#iconcss">iconCss,
            </a>
        </code>
        <code>
            <a target="_blank" class="code" href="http://ej2.syncfusion.com/angular/documentation/drop-down-button/api-dropDownButton.html#content">content
            </a>
        </code>and
        <code>
            <a target="_blank" class="code" href="http://ej2.syncfusion.com/documentation/drop-down-button/api-dropDownButton.html#items">items
            </a>
        </code>property.
    </p>
    <p>
        More information about DropDownButton can be found in this
        <a target="_blank" href="http://ej2.syncfusion.com/angular/documentation/drop-down-button/getting-started.html">
