...
<div class="control-section">
    <div class="sb-drop-down-section">
        <div id="sb-drop-down-control">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                    <ejs-dropdownbutton iconCss="e-drpdwnbtn-icons e-ddb-profile" :items="items"></ejs-dropdownbutton>
                </div>
                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                    <ejs-dropdownbutton :items="items">Profile</ejs-dropdownbutton>
                </div>
                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                    <ejs-dropdownbutton :items="items" iconCss="e-drpdwnbtn-icons e-ddb-profile">Profile</ejs-dropdownbutton>
                </div>
                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
...
<style>
/* custom code start */
#sb-drop-down-control {
  width: 100%;
  margin: 11% 0;
  text-align: center;
}

.sb-drop-down-section {
  width: 80%;
  margin: auto;
}

#sb-drop-down-control .col-xs-12 {
  margin: 15px 0;
}

@media only screen and (max-width: 500px) {
  #sb-drop-down-control .col-lg-6 {
    margin-bottom: 30px;
  }
}
...
.e-drpdwnbtn-icons {
  font-family: "e-drpbtn-icons" !important;
  speak: none;
  font-size: 55px;
  font-style: normal;
  font-weight: normal;
...
.e-ddb-dashboard::before {
  content: "\e704";
}

.e-ddb-profile::before {
  content: "\e703";
}

.e-ddb-notifications::before {
  content: "\e700";
}

.e-ddb-settings::before {
  content: "\e701";
}

.material .e-ddb-logout::before,
.bootstrap .e-ddb-logout::before {
  content: "\e706";
}

.material .e-ddb-dashboard::before,
.bootstrap .e-ddb-dashboard::before {
  content: "\e708";
}

.material .e-ddb-profile::before,
.bootstrap .e-ddb-profile::before,
.bootstrap4 .e-ddb-profile::before {
  content: "\e811";
}

.material .e-ddb-notifications::before,
.bootstrap .e-ddb-notifications::before {
  content: "\e707";
}

.material .e-ddb-settings::before,
.bootstrap .e-ddb-settings::before {
  content: "\e705";
}

.bootstrap4 .e-ddb-logout::before {
  content: "\e816";
}

.bootstrap4 .e-ddb-dashboard::before {
    content: "\e80f";
}

.bootstrap4 .e-ddb-notifications::before {
  content: "\e810";
}

.bootstrap4 .e-ddb-settings::before {
  content: "\e815";
}
</style>
  ...
  data: function() {
    return {
      items: [
        {
          text: "Dashboard",
          iconCss: "e-drpdwnbtn-icons e-ddb-dashboard"
        },
        {
          text: "Notifications",
          iconCss: "e-drpdwnbtn-icons e-ddb-notifications"
        },
        {
          text: "User Settings",
          iconCss: "e-drpdwnbtn-icons e-ddb-settings"
        },
        {
          text: "Log Out",
          iconCss: "e-drpdwnbtn-icons e-ddb-logout"
        }
      ]
    };
  }
