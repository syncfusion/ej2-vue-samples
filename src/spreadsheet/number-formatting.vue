            ...
            <e-rows>
              ...
              <e-row :index="rowIndex">
                <e-cells>
                  ...
                  <e-cell :index="formulaColIndex" formula="=SUBTOTAL(9,E4:E14)" :format="currencyFormat"></e-cell>
                </e-cells>
              </e-row>
              <e-row>
                <e-cells>
                  <e-cell :index="subTotalColIndex" value="Discount (8%):"></e-cell>
                  <e-cell :index="formulaColIndex" formula="=PRODUCT(8,E15)/100" :format="currencyFormat"></e-cell>
                </e-cells>
              </e-row>
              <e-row>
                <e-cells>
...
<script>
import Vue from "vue";
import { SpreadsheetPlugin, getFormatFromType, NumberFormatType } from "@syncfusion/ej2-vue-spreadsheet";
...
export default Vue.extend({
   data: () => {
    return {
      ...
      currencyFormat: getFormatFromType(NumberFormatType.Currency),
      width1: 120,
      width2: 180,
      width3: 100
    }
