<template>
    <div id="container">
         <ejs-accumulationchart class="chart" ref="pieInstance1" style='display:block;height:100% !important,width:100% !important;' :legendSettings="legendSettings" :tooltip="tooltip"> 
