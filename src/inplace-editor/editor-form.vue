            ...
            <div id="confirmation">
                <form id="formId" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-6 control-label" style="text-align: left;font-size: 14px;">
                        Tags</label>
                        <ejs-inplaceeditor ref="tagObj" id="inplace_tag_editor" data-underline='false' mode="Inline" type="MultiSelect" emptyText="Enter your tags" name="Tag" :value="multiValue" :validationRules="selectValidationRules" :model="selectModel" :actionSuccess= "actionSuccess">
                        </ejs-inplaceeditor>
                    </div>
                </form>
            </div>
    ...
    <div class="col-lg-4 property-section" id="editorProperty">
        <table id="property" title="Properties">
            <tr>
                ...
                <td>
                    <div>
                        <ejs-dropdownlist id="editorMode" class="form-control" width='90%' :dataSource='dataPlace' :change='changeEditorMode' :value='dataValue' :fields='placeFields'>
                        </ejs-dropdownlist>
                    </div>
                </td>
            </tr>
...
export default Vue.extend({
  ...
  methods: {
        ...
        changeEditorMode: function(args) {
           let editMode = (document.getElementById('editorMode')).value;
