    ...
    <div>
        <div class="col-md-8 control-section">
            <div class="content-wrapper">
                <ejs-gantt ref='gantt' id="GanttContainer" :dataSource="data" :taskFields="taskFields" :height="height" :rowHeight="46"
                    :taskbarHeight="25" :highlightWeekends='true'
                    :timelineSettings="timelineSettings" :splitterSettings="splitterSettings" :treeColumnIndex='1'
                    :labelSettings="labelSettings" :columns="columns">
                </ejs-gantt>
            </div>
        </div>
        <div class="col-md-4 property-section">
            <table id="property" title="Properties" style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="width: 65%;">
                        <div id='numericbox'>
                            <ejs-numerictextbox ref='topTierCount' id="count" :min='1' :max='50' format='##' :value='1'
                                :change='topTierCountchange' >
                            </ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 65%">
                        <div>
                            <ejs-dropdownlist ref='topTierUnit' id="unit" index="0" value="Week" :dataSource="unit"
                                :fields="fields" :change="topUnitChange">
                            </ejs-dropdownlist>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 65%">
                        <div>
                            <ejs-dropdownlist ref='topTierFormat' id="format" index = "1" value="MMM dd, yyyy" :dataSource = "weekformat"
                                :fields = "formatFields" :change = "topFormatChange">
                            </ejs-dropdownlist>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 65%;">
                        <div id='numericbox'>
                            <ejs-numerictextbox ref='bottomTierCount' id="btcount" :min='1' :max='50' format='##' :value='1'
                                :change='bottomTierCountchange'>
                            </ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 65%">
                        <div>
                            <ejs-dropdownlist ref='bottomTierUnit' id="btUnit" index = "1" value="Day" :dataSource="unit"
                ...
                <tr>
                    ...
                    <td style="width: 65%">
                        <div>
                            <ejs-dropdownlist ref='bottomTierFormat' id="btFormat" index = "0" :dataSource="dayformat"
                                :fields="formatFields" :change="bottomFormatChange">
                            </ejs-dropdownlist>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 65%">
                        <div style="padding-top: 0px; padding-left: 0px;">
                            <ejs-checkbox ref="mutiTaskbarCheck" class="checkbox" id="mutiTaskbar"
                                :checked="false" :change="mutiTaskbarCheckbox">
                            </ejs-checkbox>
                        </div>
                    </td>
                </tr>
        ...
        <div id="action-description">
            <p>
                This sample allows you to customize the Gantt Chart timeline by adjusting the timeline unit size, header text format, and
                count for both the top and bottom tiers, and provides an option to enable the multitaskbar feature.
            </p>
        </div>
        ...
        <div id="description">
            ...
            <p>
                Gantt component features are segregated into individual feature-wise modules. To use markers feature, inject the
                inject the <code>DayMarkers</code> module using the <code>provide</code> section.
            </p>
            <p>More information on the Essential<sup>®</sup> Vue Gantt Chart can be found in this <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/gantt/time-line/time-line">documentation section</a>.</p>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        changeDateRange: function (args) {
            this.$refs.gantt.ej2Instances.timelineSettings.viewStartDate = isNullOrUndefined(args.startDate) ? this.startDateValue : args.startDate;
            this.$refs.gantt.ej2Instances.timelineSettings.viewEndDate = isNullOrUndefined(args.endDate) ? this.end : args.endDate;
        }
    },
    provide: {
        gantt: [DayMarkers]
