...
<div id="description">
    <p>
        ...
        header texts can be customized by using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/timelineSettingsModel/#toptier">timelineSettings.topTier</a> and <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/timelineSettingsModel/#bottomtier">timelineSettings.bottomTier</a> properties.
