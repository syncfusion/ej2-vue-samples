    ...
    <div>
        <div class="col-md-8 control-section">
            <div class="content-wrapper">
                <ejs-gantt ref='gantt' id="WorkTimeRange" :dataSource="data" :height="height" :rowHeight="46"
        ...
        <div class="col-lg-4 property-section" style="padding-left: 0px;">
            <table id="property" title="Properties" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="width:70%">
                        <div style="padding:10px 10px 10px 0px; width: 114%;">
                            <ejs-numerictextbox ref='WorkStartTime' id="WorkStartTime" :min='0' :max='24'
                                :showSpinButton='true' :change="change1" :step='0.5' :value='8'></ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width:70%">
                        <div style="padding:10px 10px 10px 0px; width: 114%;">
                            <ejs-numerictextbox ref='WorkStart' id="WorkStart" :min='0' :max='24' :showSpinButton='true'
                                :step='0.5' :change="change2" :value='8'></ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <div id="action-description">
            <p>This sample visualizes the support for changing the working hours in a day. The selected start and end
                hours from the property panel will be applied to each task available in the project.</p>
        </div>
        <div id="description">
            <p>
                In this example, you can see how to render a Gantt Chart with the provided data source and customizable
                working hours in a day. You can split the working hours in a day to one or more range. So, you can also
                provide the <a target="_blank"
                    href="https://ej2.syncfusion.com/vue/documentation/api/gantt/#dayworkingtime">
            ...
            <p>You can also set different working time range for different working days using <a target="_blank"
                    ...
                    href="https://ej2.syncfusion.com/vue/documentation/api/gantt/#weekworkingtime">
                    weekWorkingTime</a> property enables you to specify different working hours for each day of the week
                in your Gantt Chart.
                By configuring this property, you can ensure that tasks are only scheduled during defined working
...
import { WorkingTimeRangeData } from './data-source';
