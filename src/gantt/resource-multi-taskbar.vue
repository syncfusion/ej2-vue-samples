...
<div id="action-description">
    <p>This sample explains you about, how to visualize the list of tasks assigned for a resource in a parent row of collapsed state.  It is also possible to change the tasks scheduling in the collapsed state.
        This feature can be enabled by setting the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#enablemultitaskbar">enableMultiTaskbar</a> property as "true".
    </p>
</div>

<div id="description">
    <p>
        In this example, you can enable taskbar drag and drop from one resource to another resource vertically by enabling <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#allowtaskbardraganddrop">allowTaskbarDragAndDrop</a> property. Also, you can prevent the taskbar overlap  in resource task by disabling the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#allowtaskbaroverlap">allowTaskbarOverlap</a> property.
    </p>
    <p>
