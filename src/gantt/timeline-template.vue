<template>
  <div class="col-lg-12 control-section">
    ...
    <div>
      <ejs-gantt ref='gantt' id="timelinetemplate" :dataSource="data" :height="height" :rowHeight="46"
        :taskbarHeight="25" :highlightWeekends='true' :allowSelection='true' :taskFields="taskFields"
        :labelSettings="labelSettings" :columns="columns" :splitterSettings="splitterSettings"
        :projectStartDate="projectStartDate" :timelineSettings="timelineSettings" :projectEndDate="projectEndDate"
