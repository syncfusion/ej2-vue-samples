...
<div id="description">
    <p>
        The <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#gridlines">gridLines</a> property is used to control the visibility of line that separates the rows and
        columns.
