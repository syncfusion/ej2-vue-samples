...
<div id="description">
    <p>Virtualization support is used to render large number tasks in Gantt with effective performance. In this mode all the tasks are
        ...
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#enablevirtualization">enableVirtualization</a> property as true. Additionally, the Gantt component now includes the timeline virtualization feature by setting the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#enabletimelinevirtualization">enableTimelineVirtualization</a> to true.</p>
    <p>This demo highlights the utilization of row and timeline virtualization features within the Gantt.</p>
    <p>By default during Virtual scroll Shimmer effect is enabled you can disable this by changing <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt#enablevirtualmaskrow">enableVirtualMaskRow</a> to false</p>
</div>
</div>
</template>
<script>
