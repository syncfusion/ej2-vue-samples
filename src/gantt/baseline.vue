...
<div id="description">
    <p>
        ...
        milestones. You can change the color for the baselines using <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/#baselinecolor">baselineColor</a> property.
    </p>
    <p>
