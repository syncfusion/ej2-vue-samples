...
<div id="description">
    <p>
        The Gantt component supports two types of selection that can be set by using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/selectionSettingsModel/#type">selectionSettings.type</a> property.
        They are:
    </p>
    <ul>
    ...
    <p>
        The Gantt component supports three types of selection modes that can be set by using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/selectionSettingsModel/#mode">selectionSettings.mode</a> property.
        They are:
    </p>
    <ul>
    ...
    <p>
        The Gantt component supports toggle selection that can be set by using the <<a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/gantt/selectionSettingsModel/#enabletoggle">selectionSettings.enableToggle</a> property.
    </p>
</div>
</div>
</template>
