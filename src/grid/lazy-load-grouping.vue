...
<div class="col-lg-12 control-section">
    ...
    <div>
        <ejs-grid ref='grid' :dataSource="lazyLoadData" :allowPaging='true' :allowGrouping='true' :groupSettings='groupSettings'>
            <e-columns>
...
<script lang="ts">
import Vue from "vue";
import { GridPlugin, GridComponent, Page, Group, LazyLoadGroup } from "@syncfusion/ej2-vue-grids";
