    ...
    <div>
        <div style="overflow-x: auto; margin-left: 4px;">
            <ejs-grid :dataSource="data" :allowResizing='true' height='400' width='850' :autoFit='true' :allowSorting='true' :allowFiltering='true' :filterSettings='filterSettings' :editSettings='editSettings' :toolbar='toolbar'>
                <e-columns>
                    <e-column field='OrderID' headerText='Order ID' minWidth='115' width='150' maxWidth='200' textAlign='Right' :isPrimaryKey='true' :validationRules='orderidrules'></e-column>
                    <e-column field='CustomerName' headerText='Customer Name' minWidth='115' width='150' :validationRules='customeridrules'></e-column>
                    <e-column field='Freight' headerText='Freight' minWidth='115' width='120' format='C2' textAlign='Right' editType='numericedit' :validationRules='freightrules'></e-column>
                    ...
                    <e-column field='ShipCountry' headerText='Ship Country' minWidth='115'  width='150' editType='dropdownedit'></e-column>
                </e-columns> 
            </ejs-grid>
        </div>
    </div>
     ...
     <div id="description">
        ...
        <p>
            ...
            To use resize feature, inject the
            <code>Resize</code> using the <code>provide</code> section.
        </p>
    </div>
