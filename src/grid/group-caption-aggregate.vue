...
<div class="col-lg-12 control-section">
    ...
    <div>
        <ejs-grid :dataSource="data" :allowPaging="true" :allowGrouping="true" :pageSettings='pageOption' :allowSorting='true' :groupSettings="groupSettings" :allowFiltering='true' :filterSettings='filterSettings'>
            <e-columns>
...
import { GridComponent, ColumnsDirective, ColumnDirective, AggregateDirective, AggregatesDirective, Aggregate, Group, Page, Sort, Filter } from "@syncfusion/ej2-vue-grids";;
...
export default {
  ...
  provide: {
      grid: [Aggregate, Group, Page, Sort, Filter]
  }
};
</script>