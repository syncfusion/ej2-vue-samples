...
<div class="col-lg-12 control-section">
    ...
    <ejs-grid ref="grid" :dataSource='employeeDataParent' height='600' width='auto' :detailDataBound='detailDataBound'
     ...
     <div id="description">
        ...
        Syncfusion<sup>®</sup> Kanban component</a></code> used to list assigned tasks and their current statuses, and the second tab contains <code><a target="_blank" class="code" 
        href="https://ej2.syncfusion.com/vue/demos/#/fluent2/chart/overview.html"> Syncfusion<sup>®</sup> Chart Component</a></code> used to 
