...
<div class="col-lg-12 control-section">
    <div id="action-description">
     ...
     <div>
        <ejs-grid ref='grid' :dataSource="lazyLoadData" :allowSorting='true' :height='400' :enableVirtualization='true' :allowGrouping='true' :groupSettings='groupSettings'>
            <e-columns>
    ...
    <p>
        Note: The <code><a target="_blank" class="code" href="https://ej2.syncfusion.com/vue/documentation/api/grid/#height">
            height</a></code> property must be defined when enabling the <code><a target="_blank" class="code"
    ...
    <p>
        ...
        <code>LazyLoadGroup</code> and <code>VirtualScroll</code> into the <code>provide</code> section.
    </p> 
    </div>
</div>
</template>
...
<script lang="ts">
import { GridComponent, ColumnDirective, ColumnsDirective, Group, LazyLoadGroup, Sort, VirtualScroll } from "@syncfusion/ej2-vue-grids";
...
export default {
  ...
  provide: {
      grid: [Group, LazyLoadGroup, VirtualScroll, Sort]
  }
}
</script>