...
<div class="col-lg-12 control-section">
    ...
    <p>
        ...
        <code>LazyLoadGroup</code> and <code>VirtualScroll</code> into the <code>provide</code> section.</p>
    </p> 
    </div>
</div>
</template>
...
<script lang="ts">
import Vue from "vue";
import { GridPlugin, GridComponent, Group, LazyLoadGroup, Sort, VirtualScroll } from "@syncfusion/ej2-vue-grids";
Vue.use(GridPlugin);
