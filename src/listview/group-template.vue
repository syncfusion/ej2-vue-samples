<template>
  <div class="col-lg-12 control-section">
    ...
    <div id="description">
      <p>The ListView component has an option to custom design the group header title with the help of <code><a target='_blank' class='code' href='https://ej2.syncfusion.com/vue/documentation/api/list-view#grouptemplate'>groupTemplate</a></code>
        property.
      </p>
    
      <p>In this example, both the group header and list items are customized using the <code><a target='_blank' class='code' href='https://ej2.syncfusion.com/vue/documentation/api/list-view#grouptemplate'>groupTemplate</a></code>
         and <code><a target='_blank' class='code' href='https://ej2.syncfusion.com/vue/documentation/api/list-view#template'>template</a></code>
         property.
      </p>
    </div>
  </div>
