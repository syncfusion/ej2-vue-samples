<template>
    ...
    <style>
        ...
        .tailwind3-dark .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl,
        .tailwind3-dark .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl:hover,
        .tailwind3-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus,
        .tailwind3-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::before,
        .tailwind3-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::after,
        ...
        .fluent2-dark .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl,
        .fluent2-dark .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl:hover,
        .fluent2-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus,
        .fluent2-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::before,
        .fluent2-dark .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::after,
        .fluent2-highcontrast .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl,
        .fluent2-highcontrast .ddl-inlinecss.e-input-group.e-control-wrapper.e-ddl:hover,
        .fluent2-highcontrast .ddl-inlinecss.e-input-group.e-ddl.e-input-focus,
        .fluent2-highcontrast .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::before,
        .fluent2-highcontrast .ddl-inlinecss.e-input-group.e-ddl.e-input-focus::after {
            border-bottom: 1px dashed #f0f0f0;
        }
