<template>
    <div class="control-pane" id="diagram-functionalities">
        ...
        <div id="action-description">
            <p>This demo sample showcases the creation of a dynamic mindmap diagram using the Vue Diagram control with
                the assistance of AI. The AI-powered diagram features nodes and connectors arranged in a mindmap layout,
                designed to
                visually organize and represent ideas and concepts. This sample is ideal for brainstorming, organizing
                thoughts,
                and visually mapping out complex information. The context menu allows for quick actions such as adding,
                editing,
        ...
        <div id="description">
            <p>
                ...
                visually
                representing the generated ideas or concepts in a mindmap format. Users can also manually add child
                nodes using
                user handles to further expand and customize the mindmap, creating an interactive and personalized
                experience.
            </p>
        </div>
    </div>
