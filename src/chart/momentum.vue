    ...
    <div class="control-section">
        ...
        <div id="description">
            ...
            <p>
                ...
                <a target="_blank"
                    href="https://ej2.syncfusion.com/vue/documentation/chart/technical-indicators/#momentum" aria-label="Navigate to the documentation for Momentum in Technical Indicators of Vue Chart component">documentation
                    section</a>.
            </p>
        </div>
    </div>
...
import { ChartComponent, SeriesDirective, SeriesCollectionDirective, Category, CandleSeries, Tooltip, DateTime, Zoom, Crosshair, LineSeries, Logarithmic, StripLine, MomentumIndicator } from "@syncfusion/ej2-vue-charts";
