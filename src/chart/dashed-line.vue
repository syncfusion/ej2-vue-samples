<template>
  <div class="control-section">
    <div align='center'>
        <ejs-chart style='display:block' :theme='theme' align='center' id='dashed-chartcontainer' :title='title' :subTitle='subTitle' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'
            :chartArea='chartArea' :width='width' :tooltip='tooltip' :crosshair='crosshair' :load='load' :axisLabelRender='axisLabelRender' :sharedTooltipRender='sharedTooltipRender' :legendRender='legendRender' :legendSettings='legendSettings'>
            <e-series-collection>
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y' width=2 :marker='marker' name='Total'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y' dashArray='4,4' width=2 :marker='marker' name='Total1'> </e-series>
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y1' width=2 :marker='marker' name='Ages 65+'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y1' dashArray='4,4' width=2 :marker='marker' name='Ages1 65+'> </e-series>  
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y2' width=2 :marker='marker' name='Ages 25-64'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y2' dashArray='4,4' width=2 :marker='marker' name='Ages1 25-64'> </e-series>  
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y3' width=2 :marker='marker' name='Under-25s'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y3' dashArray='4,4' width=2 :marker='marker' name='Unders-25s'> </e-series>  
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y4' width=2 :marker='marker' name='Under-15s'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y4' dashArray='4,4' width=2 :marker='marker' name='Unders-15s'> </e-series>  
                <e-series :dataSource='seriesData' type='Line' xName='x' yName='y5' width=2 :marker='marker' name='Under-5s'> </e-series>
                <e-series :dataSource='seriesData1' type='Line' xName='x' yName='y5' dashArray='4,4' width=2 :marker='marker' name='Unders-5s'> </e-series>    
            </e-series-collection>
        </ejs-chart>
    </div>
...
#control-container {
    ...
    #dashed-chartcontainer_Series_1, #dashed-chartcontainer_Series_3, #dashed-chartcontainer_Series_5, #dashed-chartcontainer_Series_7, #dashed-chartcontainer_Series_9, #dashed-chartcontainer_Series_11 {
...
import { ChartComponent, SeriesDirective, SeriesCollectionDirective, LineSeries, Crosshair, Double, Legend, Tooltip, Highlight } from "@syncfusion/ej2-vue-charts";
...
export default {
  ...
  data: function() {
    return {
      ...
      //Initializing Primary Y Axis
        ...
        title: 'Global Population Trends by Age Group (1950–2100)',
  ...
  provide: {
    chart: [LineSeries, Crosshair, Double, Legend, Tooltip, Highlight]
  },
  ...
  methods: {
    ...
    legendRender: function (args) {
        ...
        if (cancelLegendNames[args.text]) {
            args.cancel = true;
        }
    }
  }
