  ...
  <div class="control-section">
    ...
    <div id="description">
      ...
      <p>
        ...
        <a target="_blank"
          href="https://ej2.syncfusion.com/vue/documentation/chart/chart-type/polar#stacked-column" aria-label="Navigate to the documentation for Polar Stacked Column in Vue Chart component">documentation
          section</a>.
      </p>
    </div>
  </div>
