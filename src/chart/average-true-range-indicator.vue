    ...
    <div class="control-section">
        ...
        <div id="description">
            ...
            <p>
                ...
                <a target="_blank"
                    href="https://ej2.syncfusion.com/vue/documentation/chart/technical-indicators/#average-true-range-atr" aria-label="Navigate to the documentation for Average True Range in technical indicator of Vue Chart component">documentation
                    section</a>.
            </p>
        </div>
    </div>
...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Category, CandleSeries, Tooltip, DateTime, Zoom, Crosshair, LineSeries, Logarithmic, StripLine, AtrIndicator } from "@syncfusion/ej2-vue-charts";
