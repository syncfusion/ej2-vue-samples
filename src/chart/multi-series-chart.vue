    ...
    <div class="control-section">
        ...
        <div id="description">
            ...
            <p>
                ...
                <a target="_blank"
                    href="https://ej2.syncfusion.com/vue/documentation/chart/chart-series/#multiple-series">documentation
                    section</a>.
            </p>
        </div>
    </div>
...
import { ChartPlugin, LineSeries, StackingColumnSeries, Tooltip, ColumnSeries, Category, Legend, Highlight } from "@syncfusion/ej2-vue-charts";
Vue.use(ChartPlugin);
