    ...
    <div class="control-section">
        ...
        <div id="description">
            ...
            <p>
                ...
                <a target="_blank"
                    href="https://ej2.syncfusion.com/vue/documentation/chart/date-time-axis/#datetimecategory-axis" aria-label="Navigate to the documentation for DateTimeCategory Axis in Vue Chart component">documentation
                    section</a>.
            </p>
        </div>
    </div>
