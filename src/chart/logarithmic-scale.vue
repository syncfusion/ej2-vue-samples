  ...
  <div class="control-section">
    ...
    <div id="description">
      ...
      <p>
        ...
        <a target="_blank"
          href="https://ej2.syncfusion.com/vue/documentation/chart/logarithmic-axis/" aria-label="Navigate to the documentation for Logarithmic Axis in Vue Chart component">documentation
          section</a>.
      </p>
    </div>
  </div>
...
import { ChartComponent, SeriesDirective, SeriesCollectionDirective, SplineSeries, Tooltip, DateTime, Logarithmic, Legend } from "@syncfusion/ej2-vue-charts";
