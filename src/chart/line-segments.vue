  ...
  <div class="control-section">
    <div align='center'>
        <ejs-chart style='display:block' align='center' :theme='theme' id='chartcontainer' :title='title' :subTitle='subTitle' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'
            ...
            <e-series-collection>
                <e-series :dataSource='seriesData' type='MultiColoredLine' xName='x' yName='y' :marker='marker' :segments='segments' width=2 segmentAxis='Y' > </e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
...
import { ChartComponent, SeriesDirective, SeriesCollectionDirective, DateTime, Tooltip, ChartAnnotation, MultiColoredLineSeries, Highlight } from "@syncfusion/ej2-vue-charts";
...
export default {
  ...
  data: function() {
    ...
    marker: { visible: true, isFilled: true, border: { width: 2, color: 'white' } },
    annotations: [
        {
            content: "<div style='color:#228B22; font-weight:bold; font-size:14px'>Medium</div>",
        ...
        {
            content: "<div style='color:#0047AB; font-weight:bold;font-size:14px'>High</div>",
            coordinateUnits: 'Point',
            x: new Date(1916, 0, 1),
            y: 96.27,
            verticalAlignment: 'Middle'
        ...
        {
            content: "<div style='color:#D32F2F; font-weight:bold; font-size:14px'>Low</div>",
            coordinateUnits: 'Point',
            x: new Date(1981, 0, 1),
            y: 24.89,
            verticalAlignment: 'Middle'
    ...
    title: 'Annual Mean Precipitation in the United States (1895-2025)',
