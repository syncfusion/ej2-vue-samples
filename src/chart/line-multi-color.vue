  ...
  <div class="control-section">
    <div align='center'>
        <ejs-chart style='display:block' :theme='theme' align='center' id='chartcontainer' :title='title' :subTitle='subTitle' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'
            ...
            <e-series-collection>
                <e-series :dataSource='seriesData' type='MultiColoredLine' xName='x' yName='y' width=1.5 pointColorMapping='color' > </e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
...
import { ChartComponent, SeriesDirective, SeriesCollectionDirective, DateTime, Tooltip, MultiColoredLineSeries, Highlight } from "@syncfusion/ej2-vue-charts";
...
seriesData = seriesData.map(function(value, index) {
...
export default {
  ...
  data: function() {
    return {
        ...
        title: 'U.S. Historical Average Temperature (1895–2025)',
        subTitle: 'Source: ncei.noaa.gov',
    };
  },
  provide: {
    chart: [DateTime, Tooltip, MultiColoredLineSeries, Highlight]
  },
  methods: {
  },
