  ...
  <div>
    ...
    <div id="description">
      ...
      <p>
        ...
        <a target="_blank"
          href="https://ej2.syncfusion.com/vue/documentation/chart/chart-type/polar#scatter" aria-label="Navigate to the documentation for Polar Scatter in Vue Chart component">documentation
          section</a>.
      </p>
    </div>
  </div>
