  ...
  <div class="control-section">
      ...
      >
        <e-series-collection>
          <e-series 
            ...
            name="Stock Value" 
            :fill="fill" 
            :border="{ width: 2, color: getBorderColor() }" 
            width="2" 
    ...
    <div id="description">
      ...
      <p>
        ...
        <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/chart/cross-hair-and-track-ball/" aria-label="Navigate to the documentation for Crosshair in Vue Chart component">documentation
          section</a>.
      </p>
    </div>
  <svg style="height: 0">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      title: "Intraday Stock Price Movement",
      chartArea: { border: { width: 0 } },
      themes: ['bootstrap5', 'bootstrap5dark', 'tailwind', 'tailwinddark', 'material', 'materialdark', 'bootstrap4', 'bootstrap', 'bootstrapdark', 'fabric', 'fabricdark', 'highcontrast', 'fluent', 'fluentdark', 'material3', 'material3dark', 'fluent2', 'fluent2highcontrast', 'fluent2dark', 'tailwind3', 'tailwind3dark'],
      borderColor:  ['#FD7E14', '#FD7E14', '#5A61F6', '#8B5CF6', '#00bdae', '#9ECB08', '#a16ee5', '#a16ee5', '#a16ee5', '#4472c4', '#4472c4', '#79ECE4', '#1AC9E6', '#1AC9E6', '#6355C7', '#4EAAFF', '#6200EE', '#9BB449', '#9BB449', '#2F4074', '#8029F1']
    };
  },
  methods: {
    getBorderColor() {
      const themeIndex = this.themes.indexOf(this.theme.toLowerCase());
      return this.borderColor[themeIndex] || '#000000';
    }
  },
  provide: {
    chart: [SplineAreaSeries, Crosshair, Category, DateTime, Tooltip]
  }
};
</script>
