  ...
  <div>
    ...
    <div id="description">
      ...
      <p>
        ...
        <a target="_blank"
          href="https://ej2.syncfusion.com/vue/documentation/chart/chart-type/polar#column" aria-label="Navigate to the documentation for Polar Column in Vue Chart component">documentation
          section</a>.
      </p>
    </div>
  </div>
...
export default {
  ...
  provide: {
    chart: [Tooltip, Legend, PolarSeries, Category, RadarSeries, Highlight, ColumnSeries]
  },
  updated: function () {
