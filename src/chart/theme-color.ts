...
'#7D39C0'];
 ...
 export let bubblePointMaterialDarkColors: string[] = ["rgba(158, 203, 8, 0.5)", "rgba(86, 174, 255, 0.5)", "rgba(197, 122, 255, 0.5)", "rgba(97, 234, 169, 0.5)", "rgba(235, 187, 62, 0.5)", "rgba(244, 92, 92, 0.5)", "rgba(138, 119, 255, 0.5)",
        "rgba(99, 199, 255, 0.5)", "rgba(255, 132, 176, 0.5)", "rgba(247, 201, 40, 0.5)"];
 export let bubblePointFabricColors: string[] = ["rgba(68, 114, 196, 0.5)", "rgba(237, 125, 49, 0.5)", "rgba(255, 192, 0, 0.5)", "rgba(112, 173, 71, 0.5)", "rgba(91, 155, 213, 0.5)", "rgba(193, 193, 193, 0.5)", "rgba(111, 111, 226, 0.5)",
 ...
 export let bubblePointBootstrapColors: string[] = ["rgba(161, 110, 229, 0.5)", "rgba(247, 206, 105, 0.5)", "rgba(85, 165, 194, 0.5)", "rgba(125, 223, 30, 0.5)", "rgba(255, 110, 166, 0.5)", "rgba(121, 83, 172, 0.5)",
 ...
 export let bubblePointBootstrap5Colors: string[] = ['rgba(99, 85, 199, 0.5)', 'rgba(255, 180, 0, 0.5)', 'rgba(33, 150, 245, 0.5)','rgba(247, 82, 63, 0.5)','rgba(150, 60, 112, 0.5)',
            'rgba(75, 224, 188, 0.5)', 'rgba(253, 116, 0, 0.5)', 'rgba(201, 228, 34, 0.5)', 'rgba(222, 61, 138, 0.5)', 'rgba(22, 47, 136, 0.5)'];
 export let bubblePointBootstrap5DarkColors: string[] = ['rgba(143, 128, 244, 0.5)', 'rgba(255, 212, 109, 0.5)', 'rgba(108, 189, 255, 0.5)', 'rgba(255, 127, 113, 0.5)', 'rgba(255, 109, 179, 0.5)', 'rgba(99, 245, 210, 0.5)', 'rgba(252, 170, 101, 0.5)', 
            'rgba(236, 255, 119, 0.5)', 'rgba(239, 142, 255, 0.5)', 'rgba(95, 130, 253, 0.5)'];
 export let bubblePointFluentColors: string[] = ['rgba(26, 201, 230, 0.5)', 'rgba(218, 76, 178, 0.5)', 'rgba(237, 187, 64, 0.5)', 'rgba(175, 75, 207, 0.5)', 'rgba(255, 114, 102, 0.5)', 'rgba(27, 213, 101, 0.5)', 'rgba(238, 153, 61, 0.5)', 
            'rgba(88, 135, 255, 0.5)', 'rgba(236, 84, 141, 0.5)', 'rgba(125, 57, 192, 0.5)'];
 export let bubblePointFluentDarkColors: string[] = ['rgba(26, 201, 230, 0.5)', 'rgba(218, 76, 178, 0.5)', 'rgba(237, 187, 64, 0.5)', 'rgba(175, 75, 207, 0.5)', 'rgba(255, 114, 102, 0.5)', 'rgba(27, 213, 101, 0.5)', 'rgba(238, 153, 61, 0.5)', 
            'rgba(88, 135, 255, 0.5)', 'rgba(236, 84, 141, 0.5)', 'rgba(125, 57, 192, 0.5)'];
 export let bubblePointTailwindColors: string[] = ["rgba(90, 97, 246, 0.5)", "rgba(101, 163, 13, 0.5)", "rgba(51, 65, 85, 0.5)", "rgba(20, 184, 166, 0.5)", "rgba(139, 92, 246, 0.5)", "rgba(3, 105, 161, 0.5)", "rgba(249, 115, 22, 0.5)",
        "rgba(147, 51, 234, 0.5)", "rgba(245, 158, 11, 0.5)", "rgba(21, 128, 61, 0.5)"];
 export let bubblePointTailwindDarkColors: string[] = ["rgba(139, 92, 246, 0.5)", "rgba(34, 211, 238, 0.5)", "rgba(248, 113, 113, 0.5)", "rgba(74, 222, 128, 0.5)", "rgba(232, 121, 249, 0.5)", "rgba(252, 211, 77, 0.5)", "rgba(249, 115, 22, 0.5)",
