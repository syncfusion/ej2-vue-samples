<template>
  <div class="control-section">
    ...
    <div id="description">
      ...
      <p>
        More information about the area type series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/chart/chart-types/#area-charts">documentation section</a>.
      </p>
    </div>
  </div>
</template>
