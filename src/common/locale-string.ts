export let Locale: Object = {
    "de": {
        ...
        "spreadsheet": {
            ...
            "MatchExactCellElements": "Passen Sie den genauen Zellinhalt an",
            "EntercellAddress": "Geben Sie die Zellenadresse ein",
            ...
            "NoElements": "Wir konnten nicht finden, wonach Sie gesucht haben. Klicken Sie auf Optionen, um weitere Suchmöglichkeiten zu finden",
            "FindWhat": "Finde was",
            "ReplaceWith": "Ersetzen mit",
            "EnterValue": "Wert eingeben",
            "FileName": "Dateinamen",
            "EnterName": "Name eingeben",
            "ExtendValidation": "Die Auswahl enthält einige Zellen ohne Datenvalidierung. Möchten Sie die Validierung auf diese Zellen ausweiten?",
            "Yes": "ja",
            "No": "Nein",
            "InvalidFileName": "Dateiname enthält ungültige Zeichen.",
            "PROPER": "Wandelt einen Text in die richtige Groß-/Kleinschreibung um; erster Buchstabe in Großbuchstaben und andere Buchstaben in Kleinbuchstaben.",
            "Cut": "Ausschneiden",
            "Copy": "Kopieren",
            "Paste": "Einfügen",
            ...
            "SelectMergeType": "Wählen Sie Zusammenführungstyp",
            "MergeCellsAlert": "Durch das Zusammenführen von Zellen wird nur der Wert ganz links (ganz oben) beibehalten. Trotzdem zusammenführen?",
            "PasteMergeAlert": "Wir können das nicht mit einer Zusammenführungszelle machen.",
            "Borders": "Grenzen",
            ...
            "UnfreezeColumns": "Spalten auftauen",
            ...
            "CollapseFormulaBar": "Ausblenden der Formelleiste",
            "ExpandFormulaBar": "Erweitern Sie die Formelleiste",
            "File": "Datei",
            "Home": "Zuhause",
            "Formulas": "Formeln",
            "View": "Aussicht",
            ...
            "SortEmptyFieldError": "Für alle Sortierkriterien muss eine Spalte angegeben werden. Überprüfen Sie die ausgewählten Sortierkriterien und versuchen Sie es erneut.",
            "SortDuplicateFieldError": " wird mehrmals nach Werten sortiert. Löschen Sie die doppelten Sortierkriterien und versuchen Sie es erneut.",
            ...
            "AVERAGEA": "Berechnet den Durchschnitt für die Zellen, wobei TRUE als 1, text und FALSE als 0 ausgewertet werden.",
            ...
            "CalculateAND": "Gibt TRUE zurück, wenn alle Argumente TRUE sind, andernfalls wird FALSE zurückgegeben.",
            "CalculateOR": "Gibt TRUE zurück, wenn eines der Argumente TRUE ist, andernfalls wird FALSE zurückgegeben.",
            ...
            "FIND": "Gibt die Position einer Zeichenfolge in einer anderen Zeichenfolge zurück, wobei zwischen Groß- und Kleinschreibung unterschieden wird",
            ...
            "INTERCEPT": "Berechnet den Punkt der Y-Achsenlinie über die lineare Regression.",
            "UNIQUE": "Gibt einen eindeutigen Wert aus einem Bereich oder Array zurück",
            "TEXT": "Konvertiert einen Wert in Text im angegebenen Zahlenformat.",
            "DefineNameExists": "Dieser Name existiert bereits, probieren Sie einen anderen Namen.",
            ...
            "T": "Prüft, ob ein Wert Text ist oder nicht und gibt den Text zurück.",
            "EXACT": "Überprüft, ob zwei Textzeichenfolgen genau gleich sind und gibt TRUE oder FALSE zurück.",
            "LEN": "Gibt eine Anzahl von Zeichen in einer bestimmten Zeichenfolge zurück.",
            "MOD": "Gibt einen Rest zurück, nachdem eine Zahl durch den Divisor geteilt wurde.",
            "ODD": "Rundet eine positive Zahl auf und eine negative Zahl auf die nächste ungerade ganze Zahl ab.",
            "PI": "Gibt den Wert von pi zurück.",
            "COUNTBLANK": "Gibt die Anzahl leerer Zellen in einem angegebenen Zellbereich zurück.",
            "EVEN": "Rundet eine positive Zahl auf und eine negative Zahl auf die nächste gerade ganze Zahl ab.",
            "DECIMAL": "Konvertiert eine Textdarstellung einer Zahl in einer gegebenen Basis in eine Dezimalzahl.",
            ...
            "CODE": "Gibt den numerischen Code für das erste Zeichen in einer bestimmten Zeichenfolge zurück.",
            "DOLLAR": "Konvertiert die Zahl in währungsformatierten Text.",
            "SMALL": "Gibt den k-ten kleinsten Wert in einem gegebenen Array zurück.",
            "LARGE": "Gibt den k-größten Wert in einem bestimmten Array zurück.",
            "TIME": "Konvertiert Stunden, Minuten, Sekunden in den zeitformatierten Text.",
            "DEGREES": "Wandelt Radiant in Grad um.",
            "FACT": "Gibt die Fakultät einer Zahl zurück.",
            "MEDIAN": "Gibt den Median der angegebenen Zahlenmenge zurück.",
            "EDATE": "Gibt ein Datum mit einer angegebenen Anzahl von Monaten vor oder nach dem angegebenen Datum zurück.",
            ...
            "FileNameError": " Aktuelle Einstellungen löschen und fortfahren?",
            "ValidationError": "Dieser Wert entspricht nicht den für die Zelle definierten Datenüberprüfungsbeschränkungen.",
            ...
            "SelectUnLockedCells": "Zellen auswählen",
            "Save": "Zellen auswählen",
            "EmptyFileName": "Speichern",
            "LargeName": "Der Dateiname darf nicht leer sein.",
            ...
            "EditAlert": "Die Zelle, die Sie ändern möchten, ist geschützt. Entfernen Sie den Schutz, um Änderungen vorzunehmen.",
            "ClearValidation": "Validierung löschen",
            "ISNUMBER": "Gibt true zurück, wenn der Wert als numerischer Wert analysiert wird.",
            "ROUND": "Rundet eine Zahl auf eine bestimmte Anzahl von Ziffern.",
            "GEOMEAN": "Gibt das geometrische Mittel eines Arrays oder eines Bereichs positiver Daten zurück.",
            "POWER": "Gibt das Ergebnis einer zur Macht erhobenen Zahl zurück",
            "LOG": "Gibt den Logarithmus einer Zahl an die von Ihnen angegebene Basis zurück.",
            "TRUNC": "Gibt den abgeschnittenen Wert einer Zahl auf eine bestimmte Anzahl von Dezimalstellen zurück.",
            "EXP": "Gibt e hoch der angegebenen Zahl zurück.",
            "HighlightCellsRules": "Markieren Sie die Zellenregeln",
            "CFEqualTo": "Gleicht",
            "TextThatContains": "Text, der enthält",
            "ADateOccuring": "Ein Datum, das auftritt",
            "DuplicateValues": "Doppelte Werte",
            "TopBottomRules": "Top / Bottom Regeln",
            "Top10Items": "Top 10 Artikel",
            "Top10": "Top 10",
            "Bottom10Items": "Unten 10 Artikel",
            "Bottom10": "Unten 10",
            "AboveAverage": "Überdurchschnittlich",
            "BelowAverage": "Unterdurchschnittlich",
            "FormatCellsGreaterThan": "Formatieren Sie Zellen, die größer sind als:",
            "FormatCellsLessThan": "Formatieren Sie Zellen, die WENIGER ALS:",
            "FormatCellsBetween": "Formatieren Sie ZWISCHEN Zellen:",
            "FormatCellsEqualTo": "Formatieren Sie Zellen, die GLEICH sind:",
            "FormatCellsThatContainTheText": "Formatieren Sie Zellen, die den Text enthalten:",
            "FormatCellsThatContainADateOccurring": "Formatieren Sie Zellen, die ein Datum enthalten:",
            "FormatCellsDuplicate": "Formatieren Sie Zellen, die Folgendes enthalten:",
            "FormatCellsTop": "Formatieren Sie Zellen, die im TOP rangieren:",
            "FormatCellsBottom": "Formatieren Sie Zellen, die UNTEN rangieren:",
            "FormatCellsAbove": "Formatieren Sie Zellen, die über dem Durchschnitt liegen:",
            "FormatCellsBelow": "Formatieren Sie Zellen, die UNTER DURCHSCHNITTLICH sind:",
            "With": "mit",
            "DataBars": "Datenleisten",
            "ColorScales": "Farbskalen",
            "IconSets": "Symbolsätze",
            "ClearRules": "Klare Regeln",
            "SelectedCells": "Klare Regeln aus ausgewählten Zellen",
            ...
            "INT": "Gibt eine Zahl auf die nächste Ganzzahl zurück.",
            "SUMPRODUCT": "Gibt die Summe des Produkts bestimmter Array-Bereiche zurück.",
            ...
            "InvalidHyperlinkAlert": "Die Adresse dieser Seite ist ungültig. Überprüfen Sie die Adresse und versuchen Sie es erneut.",
            ...
            "Filter": "Filter",
            "FilterCellValue": "Filtern nach Wert der ausgewählten Zelle",
            ...
            "LightblueDataBar": "Hellblaue Datenleiste",
            "PurpleDataBar": "Lila Datenleiste",
            "GYRColorScale": "Grün - Gelb - Rot Farbskala",
            "RYGColorScale": "Rot - Gelb - Grün Farbskala",
            "GWRColorScale": "Grün - Weiß - Rot Farbskala",
            "RWGColorScale": "Rot - Weiß - Grün Farbskala",
            "BWRColorScale": "Blau - Weiß - Rot Farbskala",
            "RWBColorScale": "Rot - Weiß - Blau Farbskala",
            "WRColorScale": "Weiß - Rot Farbskala",
            "RWColorScale": "Rot - Weiß Farbskala",
            "GWColorScale": "Grün - Weiß Farbskala",
            "WGColorScale": "Weiß - Grüne Farbskala",
            "GYColorScale": "Grün - Gelbe Farbskala",
            "YGColorScale": "Gelb - Grüne Farbskala",
            ...
            "ThreeTrafficLights1": "3 Ampeln (ohne Rand)",
            ...
            "StackedBar100": "100% gestapelte Stange",
            ...
            "UnProtectWorksheet": "Titel eingeben",
            "ReEnterPassword": "Blattschutz aufheben",
            "SheetPassword": "Geben Sie das Passwort erneut ein, um fortzufahren",
            ...
            "AutoFillMergeAlertMsg": "Portables Dokumentenformat",
            "Custom": "Brauch",
        ...
        "spreadsheet": {
            ...
            "FindReplaceTooltip": "بحث واستبدال",
            "ByRow": " بواسطة الصفوف",
            ...
            "ReplaceAllEnd": " تم استبدال المباريات بـ",
            ...
            "Reference": "مرجع",
            "Workbook": "دفتر العمل",
            "NoElements": "لم نتمكن من العثور على ما كنت تبحث عنه. انقر خيارات لمزيد من طريقة البحث",
            "FindWhat": "اوجد ماذا",
            ...
            "Yes": "نعم",
            "No": "رقم",
            "InvalidFileName": "اسم الملف يحتوي على حرف غير صالح.",
            ...
            "MergeVertically": "الدمج رأسيًا",
            "Unmerge": "أفتح",
            "UnmergeCells": "خلايا غير مدمجة",
            "SelectMergeType": "حدد نوع الدمج",
            "MergeCellsAlert": "يؤدي دمج الخلايا إلى الاحتفاظ بالقيمة العلوية على اليسار (أعلى الصفحة). دمج على أي حال؟",
            "PasteMergeAlert": "لا يمكننا القيام بذلك لخلية دمج.",
            "Borders": "الحدود",
            "TopBorders": "أهم الحدود",
            "LeftBorders": "الحدود اليسرى",
            "RightBorders": "الحدود اليمنى",
            "BottomBorders": "حدود سفلية",
            ...
            "AddSheet": "إضافة ورقة",
            "ListAllSheets": "قائمة جميع الأوراق",
            "FullScreen": "كامل الشاشة",
            "CollapseToolbar": "طي شريط الأدوات",
            "ExpandToolbar": "توسيع شريط الأدوات",
            ...
            "FormulaBar": "فورمولا بار",
            "Sort": "فرز",
            "SortAscending": "تصاعدي",
            "SortDescending": "تنازلي",
            "CustomSort": "ترتيب مخصص",
            ...
            "SortEmptyFieldError": "يجب أن تحتوي جميع معايير الفرز على عمود محدد. تحقق من معايير الفرز المحددة وحاول مرة أخرى.",
            "SortDuplicateFieldError": " يتم فرزها حسب القيم أكثر من مرة. احذف معايير الفرز المكررة وحاول مرة أخرى.",
            "SortOutOfRangeError": "حدد خلية أو نطاق داخل النطاق المستخدم وحاول مرة أخرى.",
            ...
            "DestroyAlert": "هل أنت متأكد من رغبتك في تدمير المصنف الحالي دون حفظ وإنشاء مصنف جديد؟",
            ...
            "ABS": "تُرجع قيمة الرقم دون علامته.",
            ...
            "AVERAGE": "يحسب المتوسط ​​لسلسلة الأرقام و / أو الخلايا باستثناء النص.",
            "AVERAGEIF": "يحسب المتوسط ​​للخلايا بناءً على معيار محدد.",
            "AVERAGEIFS": "يحسب المتوسط ​​للخلايا بناءً على الشروط المحددة.",
            "AVERAGEA": "يحسب المتوسط ​​للخلايا تقييم TRUE كـ 1 والنص و FALSE كـ 0.",
            "COUNT": "يحسب الخلايا التي تحتوي على قيم رقمية في نطاق.",
            "COUNTIF": "تحسب الخلايا بناءً على الشرط المحدد.",
            "COUNTIFS": "تحسب الخلايا بناءً على الشروط المحددة.",
            "COUNTA": "يحسب الخلايا التي تحتوي على قيم في نطاق.",
            "MIN": "تُرجع أصغر عدد للوسائط المحددة.",
            "MAX": "إرجاع أكبر عدد من الوسائط المعطاة.",
            "DATE": "لإرجاع التاريخ بناءً على السنة والشهر واليوم.",
            ...
            "CalculateAND": "تقوم بإرجاع TRUE إذا كانت جميع الوسائط هي TRUE ، وإلا فإنها ترجع FALSE.",
            "CalculateOR": "تقوم بإرجاع TRUE إذا كانت أي من الوسائط TRUE ، وإلا فإنها ترجع FALSE.",
            ...
            "FIND": "تُرجع موضع سلسلة داخل سلسلة أخرى ، تكون حساسة لحالة الأحرف",
            "CONCATENATE": "يجمع بين سلسلتين أو أكثر معًا.",
            "CONCAT": "يسلسل قائمة أو مجموعة من سلاسل النص.",
            "SUBTOTAL": "إرجاع المجموع الفرعي للنطاق باستخدام رقم الوظيفة المحدد.",
            "RADIANS": "يحول الدرجات إلى راديان.",
            "MATCH": "إرجاع الموضع النسبي لقيمة محددة في النطاق المحدد.",
            ...
            "FileNameError": " هل تريد محو الإعدادات الحالية والمتابعة؟",
            "ValidationError": "لا تتطابق هذه القيمة مع قيود التحقق من صحة البيانات المحددة للخلية.",
            "ListLengthError": "تسمح قيم القائمة حتى 256 حرفًا فقط",
            "ProtectSheet": "حماية الورقة",
            "UnprotectSheet": "ورقة غير محمية",
            "SelectCells": "حدد الخلايا",
            "SelectUnLockedCells": "حدد الخلايا",
            "Save": "حدد الخلايا",
            "EmptyFileName": "يحفظ",
            "LargeName": "لا يمكن أن يكون اسم الملف فارغًا.",
            ...
            "FormatCellsGreaterThan": "تنسيق الخلايا الأكبر من:",
            "FormatCellsLessThan": "تنسيق الخلايا الأقل من:",
            "FormatCellsBetween": "تنسيق الخلايا الواقعة بين:",
            ...
            "FormatCellsTop": "تنسيق الخلايا التي يتم ترتيبها في الأعلى:",
            ...
            "ColorScales": "مقاييس اللون",
            "IconSets": "مجموعات الرموز",
            "ClearRules": "القواعد الواضحة",
            ...
            "SpreadsheetHyperlink": "جدول البيانات",
            ...
            "ThreeTrafficLights2": "3 إشارات ضوئية (ريميد)",
            "ThreeSigns": "3 علامات",
            ...
            "Bootstrap5Dark": "التمهيد 4",
            "Bootstrap5": "Bootstrap5 الظلام",
            "Tailwind": "التمهيد 5",
            "TailwindDark": "الريح الخلفية",
            "VerticalAxisTitle": "عنوان المحور الرأسي",
            "HorizontalAxisTitle": "عنوان المحور الأفقي",
            "EnterTitle": "أدخل العنوان",
            "UnProtectWorksheet": "أدخل العنوان",
            "ReEnterPassword": "ورقة غير محمية",
            "SheetPassword": "أعد إدخال كلمة المرور للمتابعة",
            "ProtectWorkbook": "حماية المصنف",
            "Password": "كلمة المرور (اختياري):",
            "unProtectPassword": "كلمه السر",
            ...
            "IsProtected": "محمي",
            "PDF": "نموذج المستندات المحمولة",
            "AutoFillMergeAlertMsg": "نموذج المستندات المحمولة",
        ...
        "spreadsheet": {
            ...
            "ByRow": " 按行",
            "ByColumn": "按列",
            "MatchExactCellElements": "匹配確切的單元格內容",
            "EntercellAddress": "輸入單元格地址",
            ...
            "ReplaceAllBtn": "全部替換",
            "GotoHeader": "去",
            "GotoSpecialHeader": "轉到特別",
            "Sheet": "片",
            "SearchWithin": "在內部搜索",
            "SearchBy": "搜索依據",
            "Reference": "參考",
            "Workbook": "工作簿",
            "NoElements": "我們找不到您想要的東西。單擊選項以獲取更多搜索方式",
            "FindWhat": "找什麼",
            "ReplaceWith": "用。。。來代替",
            "EnterValue": "輸入值",
            "FileName": "文件名",
            "EnterName": "输入名字",
            "ExtendValidation": "选择包含一些未经数据验证的单元格。您想将验证扩展到这些单元格吗？",
            "Yes": "是的",
            "No": "不",
            "InvalidFileName": "文件名包含无效字符。",
            "PROPER": "将文本转换为适当的大小写；首字母大写，其他字母小写。",
            "Cut": "切",
            "Copy": "複製",
            "Paste": "糊",
            "PasteSpecial": "特殊黏貼",
            ...
            "MergeCellsAlert": "合併單元格將僅保留左上（最上）值。仍然合併嗎？",
            "PasteMergeAlert": "我們無法對合併單元格執行此操作。",
            "Borders": "邊框",
            "TopBorders": "上邊界",
            "LeftBorders": "左邊界",
            "RightBorders": "右邊界",
            ...
            "ThenBy": "然後",
            "SelectAColumn": "選擇一列",
            "SortEmptyFieldError": "所有排序條件都必須指定一列。檢查所選的排序條件，然後重試。",
            "SortDuplicateFieldError": " 多次按值排序。刪除重複的排序條件，然後重試。",
            "SortOutOfRangeError": "選擇所用範圍內的一個單元格或範圍，然後重試。",
            "MultiRangeSortError": "这不能在多范围选择上完成。选择一个范围，然后重试。",
            "HideRow": "隱藏行",
            "HideRows": "隱藏行",
            "UnHideRows": "取消隱藏行",
            "HideColumn": "隱藏欄",
            ...
            "PasteAlert": "您無法在此處粘貼此內容，因為複制區域和粘貼區域的大小不同。請嘗試在其他範圍內粘貼。",
            "DestroyAlert": "您確定要銷毀當前工作簿而不保存並創建新工作簿嗎？",
            ...
            "DeleteSingleLastSheetAlert": "一本工作簿必須至少包含一個可見的工作表。",
            ...
            "ABS": "返回不帶符號的數字值。",
            "RAND": "返回0到1之間的隨機數。",
            "RANDBETWEEN": "根據指定的值返回一個隨機整數。",
            "FLOOR": "將數字四捨五入到給定因子的最接近倍數。",
            "CEILING": "將數字四捨五入到給定因子的最接近倍數。",
            "PRODUCT": "將一系列數字和/或單元格相乘。",
            "AVERAGE": "計算一系列數字和/或單元格（不包括文本）的平均值。",
            "AVERAGEIF": "根據指定的標準計算單元的平均值。",
            "AVERAGEIFS": "根據指定條件計算單元的平均值。",
            "AVERAGEA": "計算單元格的平均值，將TRUE評估為1，將文本評估為FALSE，將FALSE評估為0。",
            "COUNT": "計算包含範圍內數值的單元格。",
            ...
            "IF": "根據給定的表達式返回值。",
            "IFS": "根據給定的多個表達式返回值。",
            "CalculateAND": "如果所有參數均為TRUE，則返回TRUE，否則返回FALSE。",
            "CalculateOR": "如果任何參數為TRUE，則返回TRUE，否則返回FALSE。",
            "IFERROR": "如果未發現錯誤，則返回值，否則將返回指定值。",
            "CHOOSE": "根據索引號從值列表中返回一個值。",
            "INDEX": "根據行號和列號返回給定範圍內的單元格值。",
            "FIND": "返回一個字符串在另一個字符串中的位置，區分大小寫",
            "CONCATENATE": "將兩個或多個字符串組合在一起。",
            "CONCAT": "連接一個列表或一系列文本字符串。",
            "SUBTOTAL": "使用給定的功能編號返回範圍的小計。",
            "RADIANS": "將度轉換為弧度。",
            "MATCH": "返回給定範圍內指定值的相對位置。",
            "SLOPE": "從數據點的線性回歸返回直線的斜率。",
            "INTERCEPT": "通過線性回歸計算Y截距線的點。",
            "UNIQUE": "从范围或数组中返回唯一值",
            "TEXT": "将值转换为指定数字格式的文本。",
            "DefineNameExists": "此名稱已存在，請嘗試使用其他名稱。",
            "CircularReference": "當公式引用一個或多個循環引用時，可能會導致計算錯誤。",
            "SORT": "对数组范围进行排序",
            "T": "检查值是否为文本并返回文本。",
            "EXACT": "检查两个文本字符串是否完全相同并返回 TRUE 或 FALSE。",
            "LEN": "返回给定字符串中的多个字符。",
            "MOD": "返回一个数除以除数后的余数。",
            "ODD": "将正数向上和负数向下舍入为最接近的奇数。",
            "PI": "返回 pi 的值。",
            "COUNTBLANK": "返回指定单元格范围内的空单元格数。",
            "EVEN": "将正数向上和负数向下舍入为最接近的偶数。",
            ...
            "TIME": "将小时、分钟、秒转换为时间格式文本。",
            "DEGREES": "将弧度转换为度数。",
            "FACT": "返回数字的阶乘。",
            "MEDIAN": "返回给定数字集的中位数。",
            "EDATE": "返回指定日期之前或之后给定月数的日期。",
            ...
            "FileNameError": " 清除当前设置并继续？",
            "ValidationError": "此值與為單元定義的數據驗證限制不匹配。",
            "ListLengthError": "列表值最多只能包含256个字符",
            "ProtectSheet": "保護表",
            "UnprotectSheet": "取消保護工作表",
            "SelectCells": "選擇單元格",
            "SelectUnLockedCells": "选择单元格",
            "Save": "选择单元格",
            "EmptyFileName": "保存",
            "LargeName": "文件名不能为空。",
            "FormatCells": "格式化單元格",
            ...
            "ProtectAllowUser": "允許該工作表的所有用戶執行以下操作：",
            "EditAlert": "您要更改的單元格受到保護。要進行更改，請取消保護工作表。",
            "ClearValidation": "清除驗證",
            "ISNUMBER": "当值解析为数字值时返回true。",
            "ROUND": "将数字四舍五入到指定的位数。",
            "GEOMEAN": "返回正数据数组或范围的几何平均值。",
            "POWER": "返回加幂的数字的结果",
            "LOG": "将数字的对数返回到您指定的底数。",
            "TRUNC": "将数字的截断值返回指定的小数位数。",
            "EXP": "返回e升到给定数字的幂。",
            "HighlightCellsRules": "突出顯示單元規則",
            "CFEqualTo": "等於",
            ...
            "AboveAverage": "高於平均水平",
            "BelowAverage": "低於平均值",
            "FormatCellsGreaterThan": "格式化大於的單元格：",
            "FormatCellsLessThan": "格式化少於以下單元格：",
            "FormatCellsBetween": "格式化以下單元格：",
            ...
            "FormatCellsTop": "格式化在TOP中排名的單元格：",
            "FormatCellsBottom": "格式化位於底部的單元格：",
            "FormatCellsAbove": "格式化平均以上的單元格：",
            "FormatCellsBelow": "格式化低於平均的單元格：",
            "With": "與",
            "DataBars": "數據條",
            "ColorScales": "色標",
            "IconSets": "圖標集",
            "ClearRules": "清除規則",
            "SelectedCells": "清除選定單元格中的規則",
            "EntireSheet": "從整個工作表中清除規則",
            "LightRedFillWithDarkRedText": "淺紅色填充深紅色文本",
            "YellowFillWithDarkYellowText": "黃色填充深黃色文本",
            "GreenFillWithDarkGreenText": "綠色填充為深綠色文本",
            "RedFill": "紅色填充",
            "RedText": "紅色文字",
            "Duplicate": "重複",
            "Unique": "獨特",
            ...
            "GotoSpecial": "转到特殊...",
            "Link": "链接",
            "SpreadsheetHyperlink": "电子表格超链接",
            "Hyperlink": "超连结",
            "EditHyperlink": "编辑超链接",
            "OpenHyperlink": "打开超链接",
            "RemoveHyperlink": "删除超链接",
            "InvalidHyperlinkAlert": "该站点的地址无效。检查地址，然后重试。",
            "InsertLink": "插入连结",
            "EditLink": "编辑连结",
            "WrapText": "自动换行",
            "Update": "更新资料",
            "SortAndFilter": "排序和过滤",
            "Filter": "筛选",
            "FilterCellValue": "按选定单元格的值过滤",
            "FilterOutOfRangeError": "选择使用范围内的一个单元格或范围，然后重试。",
            ...
            "BWRColorScale": "蓝-白-红色标",
            "RWBColorScale": "红-白-蓝色标",
            ...
            "ThreeArrowsColor": "3支箭（彩色）",
            "ThreeArrowsGray": "3支箭（灰色）",
            "ThreeTriangles": "3个三角形",
            "FourArrowsColor": "4支箭（灰色）",
            "FourArrowsGray": "4个箭头（彩色）",
            "FiveArrowsColor": "5箭（灰色）",
            "FiveArrowsGray": "5支箭（彩色）",
            "ThreeTrafficLights1": "3个交通信号灯（无框）",
            "ThreeTrafficLights2": "3个交通信号灯（外缘）",
            "ThreeSigns": "3个迹象",
            "FourTrafficLights": "4个交通信号灯",
            "RedToBlack": "红变黑",
            "ThreeSymbols1": "3个符号（带圆圈）",
            "ThreeSymbols2": "3个符号（无圆圈）",
            "ThreeFlags": "3个标志",
            "ThreeStars": "3星",
            "FourRatings": "4个评分",
            "FiveQuarters": "5个季度",
            ...
            "Bootstrap4": "Bootstrap4",
            "Bootstrap5Dark": "引导程序4",
            "Bootstrap5": "Bootstrap5 暗",
            "Tailwind": "引导程序5",
            "TailwindDark": "顺风",
            "VerticalAxisTitle": "垂直轴标题",
            "HorizontalAxisTitle": "水平轴标题",
            "EnterTitle": "输入标题",
            "UnProtectWorksheet": "输入标题",
            "ReEnterPassword": "取消保护工作表",
            "SheetPassword": "重新输入密码以继续",
            ...
            "IsProtected": "受保护",
            "PDF": "便携式文件格式",
            "AutoFillMergeAlertMsg": "便携式文件格式",
            "DataLimitExceeded": "文件数据太大，处理时间较长，要继续吗？",
            "FileSizeLimitExceeded": "文件太大，需要更多时间来处理，要继续吗？",
            "Fluent": "流利",
            "FluentDark": "流利的黑暗",
            "Custom": "风俗",
            "WEEKDAY": "返回与日期对应的星期几。",
            ...
            "FillWithoutFormatting": "无格式填充",
            "CustomFormat": "自定义数字格式",
            "CustomFormatSample": "类型"
        },
        "querybuilder": {
            "AddGroup": "添加组",
            "AddCondition": "添加条件",
