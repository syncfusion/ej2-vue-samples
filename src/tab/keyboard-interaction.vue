            ...
            <ul>
              ...
              <li>
                <span class="key-class"
                  ><kbd>Down arrow</kbd> or <kbd>Up arrow</kbd></span
                >
                <span>
              ...
              <li>
                ...
                <span>
                  ...
                  Tab, the focus will not move to any Tab.</span
                >
              </li>
              <li>
                ...
                <span>
                  ...
                  element, the focus will not move to any Tab.</span
                >
              </li>
              <li>
                <span class="key-class"
                ...
                <span>
                  ...
                  when popup item is focussed.</span
                >
              </li>
              <li>
