...
<div class="chip-api">
    ...
    <div id="description">
        ...
        <ul>
            <li>Color variant can be changed by selecting the color dropdownlist from property pane. This can be achieved by using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/chips/#cssclass">CssClass</a> property.</li>
            <li><a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/chips/#leadingiconcss">Leading</a> and <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/chips/#trailingiconcss">Trailing</a> icons can be enabled by selecting Leading or Trailing Icon checkbox from property
                pane.</li>
            <li><a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/chips/#leadingiconcss">Leading</a> icon can be customized with avatar initials, icons and images from property pane</li>
            <li>Outline chip type can be enabled by checking outline checkbox from property pane. This can be achieved by using the <a target="_blank" href="https://ej2.syncfusion.com/vue/documentation/api/chips/#cssclass">CssClass</a> property.</li>
        </ul>
    </div>
</div>
</template>
