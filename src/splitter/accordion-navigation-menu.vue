...
var mvcContent = createApp({}).component("mvc", {
...
var jsContent = createApp({}).component("js", {
...
var aspGridContent = createApp({}).component("aspGrid", {
  template: `<div>
...
var aspScheduleContent = createApp({}).component("aspSchedule", {
  template: `<div>
...
var aspChartContent = createApp({}).component("aspChart", {
  template: `<div >
...
var mvcGridContent = createApp({}).component("mvcGrid", {
  template: `<div>
...
var mvcScheduleContent = createApp({}).component("mvcSchedule", {
  template: `<div>
...
var mvcChartContent = createApp({}).component("mvcChart", {
  template: `<div>
...
var jsGridContent = createApp({}).component("jsGrid", {
  template: `<div>
...
var jsScheduleContent = createApp({}).component("jsSchedule", {
  template: `<div>
...
var jsChartContent = createApp({}).component("jsChart", {
  template: `<div>
