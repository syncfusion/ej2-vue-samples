<template>
  <ejs-splitter id="innerSplitter" :separatorSize="3" :orientation="orient">
    <e-panes>
      <e-pane size="50%" :collapsible="true" :content="topPaneContent"></e-pane>
      <e-pane :collapsible="true" :content="bottomPaneContent"></e-pane>
    </e-panes>
  </ejs-splitter>
</template>
<script>
