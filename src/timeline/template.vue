<template>
  <div class="col-lg-12 control-section">
    <div class="timeline-template-section">
      <ejs-timeline id="template" cssClass="custom-timeline" template="customTemplate">
        <e-items>
          <e-item v-for="(item, index) in timelineItems" :key="index" :dotCss="item.dotCss" :content="item.content" />
        </e-items>
        <template v-slot:customTemplate="{ data }">
          <div class="template-container">
            <div class="progress-line">
              <span :class="'indicator ' + data.item.dotCss"></span>
            </div>
            <div class="timeline-content">
              ...
              <div v-if="data.itemIndex === 1" class="content-container">
                <span class="e-icons e-lock">&nbsp; <span
                    class="repo-name">Author/Getting-started-with-new-control</span></span>
                <div>
              ...
              <div v-else-if="data.itemIndex === 2" class="mention-group">
                ...
                <div class="mention-content">
                  ...
                  <div class="diffstats">
                    ...
                    <span>
                      <span class="diff-block added"></span>
                      <span class="diff-block added"></span>
                      <span class="diff-block added"></span>
                      <span class="diff-block added"></span>
                      <span class="diff-block neutral"></span>
                      lines changed
                    </span>
                  </div>
                </div>
...
.timeline-template-section [class^="sf-icon-"],
.timeline-template-section [class*=" sf-icon-"] {
...
.timeline-template-section .sf-icon-pull:before {
  content: "\e701";
}

.timeline-template-section .sf-icon-review:before {
  content: "\e703";
}

.timeline-template-section .sf-icon-create:before {
  content: "\e705";
}

.timeline-template-section .sf-icon-commit:before {
  content: "\e706";
}

.timeline-template-section .color-pr {
  color: #a371f7;
  margin: 5px 0px;
  fill: currentColor;
}
...
.custom-timeline.e-vertical .template-container .timeline-content {
  flex: 1;
  padding: 0 10px;
  margin-bottom: 30px;
}
