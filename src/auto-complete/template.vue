<template>
        ...
        <div class="control-section">
            <div id='content' style="margin: 0px auto; width:300px; padding-top: 40px;">
                <ejs-autocomplete id='employees' :dataSource='data' :fields='fields' :placeholder='watermark'
                 :headerTemplate="'hTemplate'" :itemTemplate="'iTemplate'" popupHeight="200px" cssClass='autocomplete-template'>
    ...
    <style>
        ...
        .tailwind3 .autocomplete-template .job {
            margin-top: -7px;
            margin-bottom: 5px;
        }
    
        .e-bigger.tailwind .autocomplete-template .job,
        .e-bigger.tailwind3 .autocomplete-template .job {
            margin-top: -15px;
            margin-bottom: 5px;
        }
        ...
        .tailwind3-dark .autocomplete-template .header {
            background: #374151;
