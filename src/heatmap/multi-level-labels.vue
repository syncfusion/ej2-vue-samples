...
<div id="description">
    ...
    <p>Border of the axis labels can be customized by using <a href="https://ej2.syncfusion.com/vue/documentation/api/heatmap/axisLabelBorderModel/#type" target="_blank">type</a> property.
    </p>
    <ul>
