export let arrayRowData: Object = [
    [9.6, 9.2, 10.6, 9.5, 7.9, 7.8, 7.3, 6.9, 6.7, 6.6],
    [3.9, 8.5, 10.3, 6.6, 5.5, 6.5, 7.2, 7.9, 6.8, 7.2],
    [2.6, 1.7, 2.3, 2.7, 3.6, 2.1, 2.8, 2.4, 2.5, 3.1],
    [1.4, -4.7, 5.1, 4.0, 4.0, 1.4, 2.3, 2.6, 2.3, 1.7],
    [1.0, -3.0, 3.1, 3.1, 1.7, 2.5, 2.6, 0.9, 1.4, 1.9],
    [5.1, -0.1, 7.5, 4.0, 1.9, 3.0, 0.5, -3.8, -3.6, 0.2],
    [-0.3, -2.8, 2.5, 1.6, 2.2, 1.7, 2.4, 2.6, 1.6, 2.3],
    [-0.6, -4.3, 1.9, 1.5, 1.3, 1.9, 3.1, 2.2, 1.8, 2.0],
    [0.8, -5.6, 4.0, 3.7, 0.7, 0.6, 1.6, 1.5, 1.8, 1.6],
    [5.2, -7.8, 4.5, 4.0, 3.5, 1.3, 0.7, -2.8, -0.2, 1.4],
    [0.2, -2.9, 2.0, 2.1, 0.2, 0.6, 0.6, 1.3, 1.2, 1.4],
    [-1.1, -5.4, 4.2, -0.1, 1.5, 2.0, 0.3, 1.2, 1.0, 1.2]
];

export let arrayCellData: Object = [
    [0, 0, 1.78], [0, 1, 8.52], [0, 2, 34.40], [0, 3, 38.30], [0, 4, 42.30], [0, 5, 45.80], [0, 6, 49.30],
    [1, 0, 46.76], [1, 1, 63], [1, 2, 76], [1, 3, 79.49], [1, 4, 79], [1, 5, 83], [1, 6, 84.56],
    [2, 0, 5.08], [2, 1, 17.21], [2, 2, 31.05], [2, 3, 37.18], [2, 4, 39.75], [2, 5, 43.46], [2, 6, 44.39],
    [3, 0, 51.30], [3, 1, 71.66], [3, 2, 80.30], [3, 3, 83], [3, 4, 83], [3, 5, 85.80], [3, 6, 87.12],
    [4, 0, 2.87], [4, 1, 21.02], [4, 2, 40.65], [4, 3, 45.69], [4, 4, 48.56], [4, 5, 51.04], [4, 6, 57.60],
    [5, 0, 43.08], [5, 1, 67.97], [5, 2, 71.69], [5, 3, 69.73], [5, 4, 79.30], [5, 5, 84.20], [5, 6, 87.36],
    [6, 0, 26.82], [6, 1, 70], [6, 2, 85], [6, 3, 85.38], [6, 4, 87.48], [6, 5, 89.84], [6, 6, 91.61],
    [7, 0, 68.71], [7, 1, 82], [7, 2, 81.27], [7, 3, 82.35], [7, 4, 84.17], [7, 5, 86.19], [7, 6, 30.22],
    ...
    [10, 0, 29.99], [10, 1, 66.92], [10, 2, 78.21], [10, 3, 79.05], [10, 4, 79.50], [10, 5, 89.71], [10, 6, 90.58]
];
...
export let legendSampleData: Object = [
    [10, 8, 7, 7, 10, 14, 17, 18, 18, 17, 16, 15, 13],
    [10, 8, 7, 6, 8, 13, 15, 17, 17, 17, 15, 12, 9],
    [12, 10, 8, 7, 7, 10, 15, 18, 20, 21, 20, 17, 15],
    [11, 9, 8, 7, 7, 12, 16, 18, 19, 19, 17, 15, 13],
    [15, 15, 15, 15, 16, 20, 22, 21, 21, 21, 19, 18, 17],
    [13, 13, 12, 12, 12, 15, 18, 21, 22, 21, 19, 16, 15],
    [11, 10, 9, 9, 10, 12, 14, 16, 17, 17, 16, 14, 12]
];
...
export let renderModeData: Object = [
    ...
    export function getDatasource(): number[][] {
    ...
    export let calendarDataSource: Object = [
