...
<div class="control-section">
    <div class="content-wrapper">
        <ejs-heatmap id='container' :tooltipSettings='tooltipSettings' :legendSettings='legendSettings' :titleSettings='titleSettings' :xAxis='xAxis' :yAxis='yAxis' :dataSource='dataSource' :dataSourceSettings='dataSourceSettings' :paletteSettings='paletteSettings' :cellSettings='cellSettings' :load='load'></ejs-heatmap>
    </div>
</div>
...
<section id="description" aria-label="Description of the HeatMap features demonstrated in this sample">
     <p>
        ...
        <a href="https://ej2.syncfusion.com/vue/documentation/api/heatmap/dataModel/#adaptortype" target="_blank">adaptorType </a> properties. In cell JSON data, the value for each cell is mapped using the
        <a href="https://ej2.syncfusion.com/vue/documentation/api/heatmap/dataModel/#xdatamapping" target="_blank">xDataMapping </a>,
        <a href="https://ej2.syncfusion.com/vue/documentation/api/heatmap/dataModel/#ydatamapping" target="_blank">yDataMapping </a> and
        <a href="https://ej2.syncfusion.com/vue/documentation/api/heatmap/dataModel/#valuemapping" target="_blank">valueMapping </a>properties. </p>
