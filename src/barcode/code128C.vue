...
padding-left: 18px;">
    ...
    <div id="action-description">
      <p>This sample visualizes a barcode image that presents information with a combination of numbers, uppercase and lowercase letters, and some additional characters.</p>
    </div>
    <div id="description">
      <p>
