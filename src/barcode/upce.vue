...
padding-left: 18px;">
      ...
      <div class="property-section-content">
          ...
          <div class="col-xs-10 barcode-panel-left">
            <form id="form-element" class="form-horizontal">
              <div id="barcodevaluediv">
                <ejs-textbox id="textbox" name="password" value="123456" :change="textboxchange"></ejs-textbox>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="row sb-child-row">
          ...
          <div class="col-xs-9">
            <ejs-textbox id="displayText" value="123456" :change="displayTextchange"></ejs-textbox>
          </div>
        </div>
        <div class="row sb-child-row">
    ...
    <div id="action-description">
      <p>This sample visualizes a product package identification number consist of 6 digits. A UPC-E barcode is mainly used for scanning products in small packages.</p>
    </div>
    <div id="description">
      <p>
