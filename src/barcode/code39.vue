  ...
  <div >
   <div class="col-lg-8 control-section" style="width: 64%">
      <div class="content-wrapper" style="width: 100%;height: 590px;">
        ...
        >
          <span style="font-weight: 600;"> Allowed Input characters : A-Z, 0-9 </span> 
        </div>
      </div>
    </div>
...
padding-left: 18px;">
      ...
      <div class="property-section-content">
          ...
          <div class="col-xs-10 barcode-panel-left">
            <form id="form-element" class="form-horizontal">
              <div id="barcodevaluediv">
                <ejs-textbox id="textbox" name="password" value="SYNCFUSION" :change="textboxchange"></ejs-textbox>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="row sb-child-row">
          ...
          <div class="col-xs-9">
            <ejs-textbox id="displayText" value="SYNCFUSION" :change="displayTextchange"></ejs-textbox>
          </div>
        </div>
      </div>
    </div>
    <div id="action-description">
      <p>This sample visualizes Code 39, a self-checking barcode symbology that consists of uppercase letters, numeric digits, and several special characters. It is often used to present model numbers. Code 39 is widely used in the automotive and defense industries as a standard label.</p>
    </div>
    <div id="description">
      <p>
...
let options = {
  ...
  focusout(args) {
    displayText.value = textbox.value;
    barcode.value = textbox.value;
  }
};
let formObject;
