...
padding-left: 18px;">
      ...
      <div class="property-section-content">
          ...
          <div class="col-xs-10 barcode-panel-left">
            <form id="form-element" class="form-horizontal">
              <div id="barcodevaluediv">
                <ejs-textbox id="textbox" name="password" value="01234567" :change="textboxchange"></ejs-textbox>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="row sb-child-row">
          ...
          <div class="col-xs-9">
            <ejs-textbox id="displayText" value="01234567" :change="displayTextchange"></ejs-textbox>
          </div>
        </div>
        <div class="row sb-child-row">
    ...
    <div id="action-description">
      <p>This sample visualizes how to present a model number with higher density and data security enhancements compared to Code 39. Code 93 has a native character set of 26 uppercase letters, 10 digits, and 7 special characters.</p>
    </div>
    <div id="description">
      <p>
