...
padding-left: 18px;">
          ...
          <div class="col-xs-10 barcode-panel-left">
            <form id="form-element" class="form-horizontal">
              <div id="barcodevaluediv">
                <ejs-textbox id="textbox" name="password" value="11223344" :change="textboxchange"></ejs-textbox>
              </div>
            </form>
          </div>
        </div>
    ...
    <div id="action-description">
      <p>This sample visualizes the 8-digit Global Trade Identification Numbers. It was introduced for use on small
        packages where an EAN-8 barcode would be too large.</p>
    </div>
    <div id="description">
      <p>
