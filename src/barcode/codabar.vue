...
padding-left: 18px;">
      ...
      <div class="property-section-content">
        <div class="row sb-child-row">
          ...
          <div class="col-xs-10 barcode-panel-left" style="padding-left: 0px">
    ...
    <div id="action-description">
      <p>This sample visualizes a barcode that is designed to be accurately read even when printed with dot matrix printers. This type of barcode is widely used in applications that require serial numbers, such as blood bank management, slips for door-to door delivery services, and member cards.</p>
    </div>
    <div id="description">
      <p>
