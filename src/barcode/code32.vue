...
padding-left: 18px;">
    ...
    <div id="action-description">
      <p>This sample visualizes the pharmaceutical code that encodes numeric data in a compressed format. This type of barcode supports all numeric digits and all uppercase letters.
        </p>
    </div>
    <div id="description">
      <p>
