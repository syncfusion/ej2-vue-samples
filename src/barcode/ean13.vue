...
padding-left: 18px;">
          ...
          <div class="col-xs-10 barcode-panel-left">
            <form id="form-element" class="form-horizontal">
              <div id="barcodevaluediv">
                <ejs-textbox id="textbox" name="password" value="9735940564824" :change="textboxchange"></ejs-textbox>
              </div>
            </form>
          </div>
        </div>
    ...
    <div id="action-description">
      <p>This sample visualizes the 13-digit Global Trade Identification Numbers. These 13 digits comprise the following components: GS1 company prefix, manufacturer code, product code, and check digit.</p>
    </div>
    <div id="description">
      <p>
