...
export default {
  ...
  data: function() {
    return {
      ...
      logo: { imageSource: logoImageSource },
      type: "QRCode",
      value: "Syncfusion",
      bgcolorvalue: "#fff",
      fontcolorvalue: "#000",
      ...
      showLogo: arg => {
        if (barCodeInstance.logo) {
          barCodeInstance.logo.imageSource = arg.checked ? logoImageSource : '';
        }
      },
      svgModechange: arg => {
