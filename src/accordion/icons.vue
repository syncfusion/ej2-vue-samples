<template>
    <div class="control-section accordion-icons">
...
/* custom code start */
<style>
.accordion-icons .accordion-control-wrapper {
        max-width: 500px;
        margin: auto;
 ...
 @font-face {
    ...
    .accordion-icons .e-acrdn-icons {
        font-family: 'acrdn-icons-icon';
        font-size: 16px;
        vertical-align: middle;
    }

    .bootstrap4 .accordion-icons .e-acrdn-icons {
        font-size: 14px !important;
    }

    .e-bigger.bootstrap4 .accordion-icons .e-acrdn-icons {
        font-size: 16px !important;
    }

    .e-bigger.bootstrap4 .accordion-icons .e-acrdn-icons:not(.e-icons) {
        padding: 0 12px 0 0 !important;
    }

    .bootstrap4 .accordion-icons .e-acrdn-icons:not(.e-icons) {
