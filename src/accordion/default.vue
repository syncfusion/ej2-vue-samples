  ...
  <div class="control-section accordion-default">
    ...
    <ejs-accordion>
      <e-accordionitems>
        ...
        <p>This sample demonstrates the default functionalities of the <code>Accordion</code>. Click on the <code>header</code> element to expand/collapse the corresponding Accordion panel, and displays its content.</p>
    </div>
...
.accordion-default .accordion-control-wrapper {
        max-width: 500px;
        margin: auto;
...
@font-face {
    font-family: 'acrdn-icons-default';
...
.accordion-default .e-acrdn-icons {
    font-family: 'acrdn-icons-default';
    font-size: 16px;
}
...
.accordion-default .e-acrdn-icons:not(.e-icons) {
    padding: 0 16px 0 0;
    vertical-align: middle;
}

.accordion-default .e-rtl .e-acrdn-icons:not(.e-icons) {
    padding: 0 0 0 16px;
    vertical-align: middle;
}
...
.accordion-default .e-accordion table {
...
.accordion-default .e-accordion table th,
.accordion-default .e-accordion table td {
    font-weight: normal;
    padding: 5px;
    text-align: left;
