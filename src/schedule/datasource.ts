...
export function generateEvents(count: number = 250, yearCount: number = 5, date: Date = new Date()): Object[] {
    let names: string[] = [
...
export function generateStaticEvents(start: Date, resCount: number, overlapCount: number): Object[] {
    let data: Object[] = [];
    let id: number = 1;
...
export function generateResourceData(startId: number, endId: number, text: string): Object[] {
    let data: Array<{ [key: string]: Object }> = [];
    let colors: string[] = [
        '#ff8787', '#9775fa', '#748ffc', '#3bc9db', '#69db7c',
        '#fdd835', '#748ffc', '#9775fa', '#df5286', '#7fa900',
        '#fec200', '#5978ee', '#00bdae', '#ea80fc',
...
export let scheduleEvent: object[] = [
    {
        Id: 1,
        Subject: 'Explosion of Betelgeuse Star',
        Location: 'Space Centre USA',
