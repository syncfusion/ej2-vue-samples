<template>
    <div>
        ...
        <div id="action-description">
            <p>This demo showcases the way of binding remote services to Schedule component. Here, the DataManager is used to
                bind the remote data with Schedule.
            </p>
        </div>
        <div id="description">
            <p>
                Schedule can be bound to remote services by assigning the
                <code>dataSource</code> property with the instance of
                <code><a target="_blank" class="code" href="http://ej2.syncfusion.com/documentation/data/api-dataManager.html">DataManager</a></code>.
            </p>
