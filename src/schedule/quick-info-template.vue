...
<style>
    ...
    .bootstrap5_3-dark .quick-info-template .quick-info-header,
    ...
    .bootstrap5_3-dark .quick-info-template .quick-info-header-content,
    ...
    .bootstrap5_3-dark .quick-info-content .event-content div label,
    .bootstrap5_3-dark .quick-info-content .event-content div span,
